...
export const FIX_THE_BUG_QUESTIONS: QuizQuestion[] = [
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of What are linters?."
    ],
    source: "44-react",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of What architectural solutions for React do you know?."
    ],
    source: "44-react",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of What is Feature-Sliced Design?."
    ],
    source: "44-react",
    estimatedMinutes: 3
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of How to perform automatic redirect after login?."
    ],
  ...
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of Built-in Hooks: The built-in Hooks are divided into 2 parts as given below:."
    ],
    source: "interviewbit-70",
    estimatedMinutes: 3
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of What is the Context API? When should you use it instead of prop drilling?."
    ],
    source: "interviewbit-70",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of What is the purpose of the key prop in React?."
    ],
    source: "100-react",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of Why does React recommend against mutating state?."
    ],
    source: "100-react",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of What is the Flux pattern?."
    ],
    source: "100-react",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of How to format date using react-intl?."
    ],
    source: "100-react",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of What are the Benefits of Using React-Redux?."
    ],
    source: "150-react",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of Explain Why and How to Update State of Components Using Callback?."
    ],
    source: "150-react",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of Rules of Hooks: How to Avoid Subtle Bugs."
    ],
    source: "150-react",
    estimatedMinutes: 3
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of Hook Types and Patterns \ufffd\ufffd\ufffd Built-In and Custom Hooks That Matter."
    ],
    source: "150-react",
    estimatedMinutes: 3
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of What are the core principles of Redux?."
    ],
    source: "300-react",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of What is the proper way to access Redux store?."
    ],
    source: "300-react",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of What is the purpose of the constants in Redux?."
    ],
    source: "300-react",
    estimatedMinutes: 2
  },
  {
    ...
    correctAnswer: "A",
    explanation: "Some of the main features of Redux DevTools are below, Lets you inspect every state and action payload. Lets you go back in time by cancelling actions. If you change the reducer code, each staged action will be re-evaluated. If the reducers throw, you will see during which action this happened, and what the error was. With persistState() store enhancer, you can persist debug sessions across page reloads. \ufffd\ufffd\ufffd Back to Top",
    ...
    hints: [
      "Consider the core principles and trade-offs of What are the features of Redux DevTools?."
    ],
    source: "300-react",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of How to debug your React Native?."
    ],
    source: "300-react",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of What is the difference between Flow and PropTypes?."
    ],
    source: "300-react",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of What is the difference between React and Angular?."
    ],
    source: "300-react",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of Do I need to keep all my state into Redux? Should I ever use react internal state?."
    ],
    source: "300-react",
    estimatedMinutes: 3
  },
  {
    ...
    correctAnswer: "A",
    explanation: "Apart from error messages and javascript stack, React16 will display the component stack trace with file names and line numbers using error boundary concept. For example, BuggyCounter component displays the component stack trace as below, \ufffd\ufffd\ufffd Back to Top",
    ...
    hints: [
      "Consider the core principles and trade-offs of What is the benefit of component stack trace from error boundary?."
    ],
    source: "300-react",
    estimatedMinutes: 3
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of What is the purpose of displayName class property?."
    ],
    source: "300-react",
    estimatedMinutes: 4
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of How to debug forwardRefs in DevTools?."
    ],
    source: "300-react",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of What is the purpose of eslint plugin for hooks?."
    ],
    source: "300-react",
    estimatedMinutes: 3
  },
  {
    ...
    correctAnswer: "A",
    explanation: "Below are some of the benefits of using typescript with Reactjs, It is possible to use latest JavaScript features Use of interfaces for complex type definitions IDEs such as VS Code was made for TypeScript Avoid bugs with the ease of readability and Validation \ufffd\ufffd\ufffd Back to Top",
    ...
    hints: [
      "Consider the core principles and trade-offs of What are the benefits of using typescript with reactjs?."
    ],
    source: "300-react",
    estimatedMinutes: 2
  },
  {
    ...
    title: "Explain state management strategies in a large frontend application. n   Answer State management is one of the most critical frontend architecture decisions. Getting it wrong leads to prop drilling hell, stale data, and bugs. The 4 types of state: Local UI state \\227 isOpen, inputValue, tab selection \\(useState\\) Server/cache state \\227 API data, loading, errors \\(React Query/SWR\\) Global client state \\227 auth user, theme, cart \\(Zustand/Redux\\) URL state \\227 filters, pagination, search params \\(useSearchParams\\) Which tool for which state: useState \\227 simple local UI state useReducer \\227 complex local state with multiple actions Context \\227 low-frequency global state \\(theme, locale\\) Zustand/Jotai \\227 medium global state, simple API Redux Toolkit \\227 large apps, complex async flows, devtools React Query/SWR \\227 ALL server state \\(replaces 90% of Redux use\\) Rule of thumb: Put state as close to where it is used as possible Use React Query for server state before reaching for Redux  1 // React Query: server state \\(replaces Redux for API data\\)  2 const   useProducts   =   \\( filters \\)   = >   {  3     return   useQuery \\( {  4         queryKey :   [ 'products' ,   filters ] ,  5         queryFn :   \\( \\)   = >   api . getProducts \\( filters \\) ,  6         staleTime :   5   *   60   *   1000 ,     // 5 min \\227 don't refetch if fresh  7         gcTime :   10   *   60   *   1000 ,         // 10 min \\227 keep in memory  8     } \\)  9 } 10 11 // Zustand: global client state \\(auth, cart, theme\\) 12 const   useCartStore   =   create \\( \\( set ,   get \\)   = >   \\( { 13     items :   [ ] , 14     addItem :   \\( product \\)   = >   set \\( state   = >   \\( { 15         items :   [ . . . state . items ,   product ] 16     } \\) \\) , 17     total :   \\( \\)   = >   get \\( \\) . items . reduce \\( \\( sum ,   i \\)   = >   sum   +   i . price ,   0 \\) , 18     clearCart :   \\( \\)   = >   set \\( {   items :   [ ]   } \\) 19 } \\) \\) 20 21 // URL state: filters and pagination \\(shareable, bookmarkable\\) 22 const   useProductFilters   =   \\( \\)   = >   { 23     const   [ params ,   setParams ]   =   useSearchParams \\( \\) 24     return   { 25         category :   params . get \\( 'category' \\)   | |   'all' , 26         page :   Number \\( params . get \\( 'page' \\)   | |   1 \\) , Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 4/42",
    prompt: "Explain state management strategies in a large frontend application. n   Answer State management is one of the most critical frontend architecture decisions. Getting it wrong leads to prop drilling hell, stale data, and bugs. The 4 types of state: Local UI state \\227 isOpen, inputValue, tab selection \\(useState\\) Server/cache state \\227 API data, loading, errors \\(React Query/SWR\\) Global client state \\227 auth user, theme, cart \\(Zustand/Redux\\) URL state \\227 filters, pagination, search params \\(useSearchParams\\) Which tool for which state: useState \\227 simple local UI state useReducer \\227 complex local state with multiple actions Context \\227 low-frequency global state \\(theme, locale\\) Zustand/Jotai \\227 medium global state, simple API Redux Toolkit \\227 large apps, complex async flows, devtools React Query/SWR \\227 ALL server state \\(replaces 90% of Redux use\\) Rule of thumb: Put state as close to where it is used as possible Use React Query for server state before reaching for Redux  1 // React Query: server state \\(replaces Redux for API data\\)  2 const   useProducts   =   \\( filters \\)   = >   {  3     return   useQuery \\( {  4         queryKey :   [ 'products' ,   filters ] ,  5         queryFn :   \\( \\)   = >   api . getProducts \\( filters \\) ,  6         staleTime :   5   *   60   *   1000 ,     // 5 min \\227 don't refetch if fresh  7         gcTime :   10   *   60   *   1000 ,         // 10 min \\227 keep in memory  8     } \\)  9 } 10 11 // Zustand: global client state \\(auth, cart, theme\\) 12 const   useCartStore   =   create \\( \\( set ,   get \\)   = >   \\( { 13     items :   [ ] , 14     addItem :   \\( product \\)   = >   set \\( state   = >   \\( { 15         items :   [ . . . state . items ,   product ] 16     } \\) \\) , 17     total :   \\( \\)   = >   get \\( \\) . items . reduce \\( \\( sum ,   i \\)   = >   sum   +   i . price ,   0 \\) , 18     clearCart :   \\( \\)   = >   set \\( {   items :   [ ]   } \\) 19 } \\) \\) 20 21 // URL state: filters and pagination \\(shareable, bookmarkable\\) 22 const   useProductFilters   =   \\( \\)   = >   { 23     const   [ params ,   setParams ]   =   useSearchParams \\( \\) 24     return   { 25         category :   params . get \\( 'category' \\)   | |   'all' , 26         page :   Number \\( params . get \\( 'page' \\)   | |   1 \\) , Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 4/42 \u2014 explain the behavior and mechanism.",
    level: "senior",
    type: "fix",
    category: "system_design",
    subject: "hooks",
    ...
    correctAnswer: "A",
    explanation: "27 setFilter : ( key , val ) = > setParams ( p = > { p . set ( key , val ) ; return p } ) 28 } 29 } 30 31 // Context: theme (low frequency changes \\227 no re-render problem) 32 const ThemeContext = createContext ( 'light' ) 33 const useTheme = ( ) = > useContext ( ThemeContext ) n Interview Tip: The biggest mistake in frontend: using Redux for server state (API data). React Query or SWR handle loading, caching, refetching, and deduplication automatically. Only use Redux/Zustand for true client-side global state like auth user, cart, or UI preferences. Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn Frontend System Design | Comment 'FSD' for full PDF | Save \\267 Share \\267 Repost 4/42 nn FE Design",
    interviewLine: "Interview takeaway: Clearly articulate the underlying mechanism, lifecycle role, and performance trade-offs of Explain state management strategies in a large frontend application. n   Answer State management is one of the most critical frontend architecture decisions. Getting it wrong leads to prop drilling hell, stale data, and bugs. The 4 types of state: Local UI state \\227 isOpen, inputValue, tab selection \\(useState\\) Server/cache state \\227 API data, loading, errors \\(React Query/SWR\\) Global client state \\227 auth user, theme, cart \\(Zustand/Redux\\) URL state \\227 filters, pagination, search params \\(useSearchParams\\) Which tool for which state: useState \\227 simple local UI state useReducer \\227 complex local state with multiple actions Context \\227 low-frequency global state \\(theme, locale\\) Zustand/Jotai \\227 medium global state, simple API Redux Toolkit \\227 large apps, complex async flows, devtools React Query/SWR \\227 ALL server state \\(replaces 90% of Redux use\\) Rule of thumb: Put state as close to where it is used as possible Use React Query for server state before reaching for Redux  1 // React Query: server state \\(replaces Redux for API data\\)  2 const   useProducts   =   \\( filters \\)   = >   {  3     return   useQuery \\( {  4         queryKey :   [ 'products' ,   filters ] ,  5         queryFn :   \\( \\)   = >   api . getProducts \\( filters \\) ,  6         staleTime :   5   *   60   *   1000 ,     // 5 min \\227 don't refetch if fresh  7         gcTime :   10   *   60   *   1000 ,         // 10 min \\227 keep in memory  8     } \\)  9 } 10 11 // Zustand: global client state \\(auth, cart, theme\\) 12 const   useCartStore   =   create \\( \\( set ,   get \\)   = >   \\( { 13     items :   [ ] , 14     addItem :   \\( product \\)   = >   set \\( state   = >   \\( { 15         items :   [ . . . state . items ,   product ] 16     } \\) \\) , 17     total :   \\( \\)   = >   get \\( \\) . items . reduce \\( \\( sum ,   i \\)   = >   sum   +   i . price ,   0 \\) , 18     clearCart :   \\( \\)   = >   set \\( {   items :   [ ]   } \\) 19 } \\) \\) 20 21 // URL state: filters and pagination \\(shareable, bookmarkable\\) 22 const   useProductFilters   =   \\( \\)   = >   { 23     const   [ params ,   setParams ]   =   useSearchParams \\( \\) 24     return   { 25         category :   params . get \\( 'category' \\)   | |   'all' , 26         page :   Number \\( params . get \\( 'page' \\)   | |   1 \\) , Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 4/42.",
    misconception: "Common misconception: misunderstanding the execution lifecycle, reactivity triggers, or edge cases of Explain state management strategies in a large frontend application. n   Answer State management is one of the most critical frontend architecture decisions. Getting it wrong leads to prop drilling hell, stale data, and bugs. The 4 types of state: Local UI state \\227 isOpen, inputValue, tab selection \\(useState\\) Server/cache state \\227 API data, loading, errors \\(React Query/SWR\\) Global client state \\227 auth user, theme, cart \\(Zustand/Redux\\) URL state \\227 filters, pagination, search params \\(useSearchParams\\) Which tool for which state: useState \\227 simple local UI state useReducer \\227 complex local state with multiple actions Context \\227 low-frequency global state \\(theme, locale\\) Zustand/Jotai \\227 medium global state, simple API Redux Toolkit \\227 large apps, complex async flows, devtools React Query/SWR \\227 ALL server state \\(replaces 90% of Redux use\\) Rule of thumb: Put state as close to where it is used as possible Use React Query for server state before reaching for Redux  1 // React Query: server state \\(replaces Redux for API data\\)  2 const   useProducts   =   \\( filters \\)   = >   {  3     return   useQuery \\( {  4         queryKey :   [ 'products' ,   filters ] ,  5         queryFn :   \\( \\)   = >   api . getProducts \\( filters \\) ,  6         staleTime :   5   *   60   *   1000 ,     // 5 min \\227 don't refetch if fresh  7         gcTime :   10   *   60   *   1000 ,         // 10 min \\227 keep in memory  8     } \\)  9 } 10 11 // Zustand: global client state \\(auth, cart, theme\\) 12 const   useCartStore   =   create \\( \\( set ,   get \\)   = >   \\( { 13     items :   [ ] , 14     addItem :   \\( product \\)   = >   set \\( state   = >   \\( { 15         items :   [ . . . state . items ,   product ] 16     } \\) \\) , 17     total :   \\( \\)   = >   get \\( \\) . items . reduce \\( \\( sum ,   i \\)   = >   sum   +   i . price ,   0 \\) , 18     clearCart :   \\( \\)   = >   set \\( {   items :   [ ]   } \\) 19 } \\) \\) 20 21 // URL state: filters and pagination \\(shareable, bookmarkable\\) 22 const   useProductFilters   =   \\( \\)   = >   { 23     const   [ params ,   setParams ]   =   useSearchParams \\( \\) 24     return   { 25         category :   params . get \\( 'category' \\)   | |   'all' , 26         page :   Number \\( params . get \\( 'page' \\)   | |   1 \\) , Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 4/42.",
    hints: [
      "Consider the core principles and trade-offs of Explain state management strategies in a large frontend application. n   Answer State management is one of the most critical frontend architecture decisions. Getting it wrong leads to prop drilling hell, stale data, and bugs. The 4 types of state: Local UI state \\227 isOpen, inputValue, tab selection \\(useState\\) Server/cache state \\227 API data, loading, errors \\(React Query/SWR\\) Global client state \\227 auth user, theme, cart \\(Zustand/Redux\\) URL state \\227 filters, pagination, search params \\(useSearchParams\\) Which tool for which state: useState \\227 simple local UI state useReducer \\227 complex local state with multiple actions Context \\227 low-frequency global state \\(theme, locale\\) Zustand/Jotai \\227 medium global state, simple API Redux Toolkit \\227 large apps, complex async flows, devtools React Query/SWR \\227 ALL server state \\(replaces 90% of Redux use\\) Rule of thumb: Put state as close to where it is used as possible Use React Query for server state before reaching for Redux  1 // React Query: server state \\(replaces Redux for API data\\)  2 const   useProducts   =   \\( filters \\)   = >   {  3     return   useQuery \\( {  4         queryKey :   [ 'products' ,   filters ] ,  5         queryFn :   \\( \\)   = >   api . getProducts \\( filters \\) ,  6         staleTime :   5   *   60   *   1000 ,     // 5 min \\227 don't refetch if fresh  7         gcTime :   10   *   60   *   1000 ,         // 10 min \\227 keep in memory  8     } \\)  9 } 10 11 // Zustand: global client state \\(auth, cart, theme\\) 12 const   useCartStore   =   create \\( \\( set ,   get \\)   = >   \\( { 13     items :   [ ] , 14     addItem :   \\( product \\)   = >   set \\( state   = >   \\( { 15         items :   [ . . . state . items ,   product ] 16     } \\) \\) , 17     total :   \\( \\)   = >   get \\( \\) . items . reduce \\( \\( sum ,   i \\)   = >   sum   +   i . price ,   0 \\) , 18     clearCart :   \\( \\)   = >   set \\( {   items :   [ ]   } \\) 19 } \\) \\) 20 21 // URL state: filters and pagination \\(shareable, bookmarkable\\) 22 const   useProductFilters   =   \\( \\)   = >   { 23     const   [ params ,   setParams ]   =   useSearchParams \\( \\) 24     return   { 25         category :   params . get \\( 'category' \\)   | |   'all' , 26         page :   Number \\( params . get \\( 'page' \\)   | |   1 \\) , Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 4/42."
    ],
  ...
  },
  {
    ...
    title: "How do you design a drag-and-drop interface? n   Answer Drag and drop requires careful handling of mouse/touch events, accessibility, and state management. Libraries \\(use these, don't build from scratch\\): @dnd-kit/core \\227 most modern, accessible, sortable, tree react-beautiful-dnd \\227 kanban, lists \\(Atlassian's library\\) react-dropzone \\227 file drag-and-drop only Key concepts in @dnd-kit: DndContext \\227 wraps everything, handles drag events Draggable \\(useDraggable\\) \\227 items that can be picked up Droppable \\(useDroppable\\) \\227 areas that can receive items SortableContext \\227 ordered list reordering arrayMove \\227 reorder arrays after drop Accessibility for DnD: Keyboard support \\227 Space to pick up, arrows to move, Space to drop Screen reader announcements \\227 'Dragging item X. Use arrow keys to move.' @dnd-kit handles this automatically  1 import   {   DndContext ,   closestCenter   }   from   '@dnd-kit/core'  2 import   {   SortableContext ,   useSortable ,   arrayMove   }   from   '@dnd-kit/sortable'  3 import   {   CSS   }   from   '@dnd-kit/utilities'  4  5 // Sortable item  6 const   SortableCard   =   \\( {   id ,   task   } \\)   = >   {  7     const   {   attributes ,   listeners ,   setNodeRef ,  8                     transform ,   transition ,   isDragging   }   =   useSortable \\( {   id   } \\)  9     return   \\( 10         < div 11             ref = { setNodeRef } 12             style = { { 13                 transform :   CSS . Transform . toString \\( transform \\) , 14                 transition , 15                 opacity :   isDragging   ?   0 . 5   :   1 , 16             } } 17             { . . . attributes } 18             { . . . listeners } 19         > 20             < TaskCard   task = { task }   / > 21         < / div > 22     \\) 23 } 24 25 // Kanban board 26 const   KanbanBoard   =   \\( \\)   = >   { 27     const   [ tasks ,   setTasks ]   =   useState \\( initialTasks \\) 28 Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 23/42",
    prompt: "How do you design a drag-and-drop interface? n   Answer Drag and drop requires careful handling of mouse/touch events, accessibility, and state management. Libraries \\(use these, don't build from scratch\\): @dnd-kit/core \\227 most modern, accessible, sortable, tree react-beautiful-dnd \\227 kanban, lists \\(Atlassian's library\\) react-dropzone \\227 file drag-and-drop only Key concepts in @dnd-kit: DndContext \\227 wraps everything, handles drag events Draggable \\(useDraggable\\) \\227 items that can be picked up Droppable \\(useDroppable\\) \\227 areas that can receive items SortableContext \\227 ordered list reordering arrayMove \\227 reorder arrays after drop Accessibility for DnD: Keyboard support \\227 Space to pick up, arrows to move, Space to drop Screen reader announcements \\227 'Dragging item X. Use arrow keys to move.' @dnd-kit handles this automatically  1 import   {   DndContext ,   closestCenter   }   from   '@dnd-kit/core'  2 import   {   SortableContext ,   useSortable ,   arrayMove   }   from   '@dnd-kit/sortable'  3 import   {   CSS   }   from   '@dnd-kit/utilities'  4  5 // Sortable item  6 const   SortableCard   =   \\( {   id ,   task   } \\)   = >   {  7     const   {   attributes ,   listeners ,   setNodeRef ,  8                     transform ,   transition ,   isDragging   }   =   useSortable \\( {   id   } \\)  9     return   \\( 10         < div 11             ref = { setNodeRef } 12             style = { { 13                 transform :   CSS . Transform . toString \\( transform \\) , 14                 transition , 15                 opacity :   isDragging   ?   0 . 5   :   1 , 16             } } 17             { . . . attributes } 18             { . . . listeners } 19         > 20             < TaskCard   task = { task }   / > 21         < / div > 22     \\) 23 } 24 25 // Kanban board 26 const   KanbanBoard   =   \\( \\)   = >   { 27     const   [ tasks ,   setTasks ]   =   useState \\( initialTasks \\) 28 Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 23/42",
    level: "senior",
    type: "fix",
    category: "system_design",
    ...
    correctAnswer: "A",
    explanation: "29 const handleDragEnd = ( event ) = > { 30 const { active , over } = event 31 if ( ! over | | active . id = = = over . id ) return 32 setTasks ( tasks = > { 33 const oldIdx = tasks . findIndex ( t = > t . id = = = active . id ) 34 const newIdx = tasks . findIndex ( t = > t . id = = = over . id ) 35 return arrayMove ( tasks , oldIdx , newIdx ) // reorder array 36 } ) 37 // Persist to server 38 api . reorderTasks ( { taskId : active . id , newIndex : over . id } ) 39 } 40 41 return ( 42 < DndContext collisionDetection = { closestCenter } onDragEnd = { handleDragEnd } > 43 < SortableContext items = { tasks . map ( t = > t . id ) } > 44 { tasks . map ( task = > < SortableCard key = { task . id } id = { task . id } task = { task } / > ) } 45 < / SortableContext > 46 < / DndContext > 47 ) 48 } n Interview Tip: Persist drag-and-drop order immediately with an optimistic update. Update local state on dragEnd, then sync to server in the background. If server fails, rollback. Users expect their drag order to be saved instantly \\227 a loading spinner after drop feels broken. Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn Frontend System Design | Comment 'FSD' for full PDF | Save \\267 Share \\267 Repost 23/42 nn FE Design",
