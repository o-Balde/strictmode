...
export const LIVE_CODING_QUESTIONS: QuizQuestion[] = [
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of How does React Router work, and how do you implement dynamic routing?."
    ],
    source: "100-react",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of How would you implement route guards or private routes in React?."
    ],
    source: "100-react",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of How to Write a Comment in React?."
    ],
    source: "150-react",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of Write a Program to Create a Counter with Increment and Decrement."
    ],
    source: "150-react",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of JSX: What It Is and Why We Write It."
    ],
    source: "150-react",
    estimatedMinutes: 2
  },
  {
    ...
    correctAnswer: "A",
    explanation: "The comments in React/JSX are similar to JavaScript Multiline comments but are wrapped in curly braces. Single-line comments: Multi-line comments: \ufffd\ufffd\ufffd Back to Top",
    ...
    hints: [
      "Consider the core principles and trade-offs of How to write comments in React?."
    ],
    source: "300-react",
    estimatedMinutes: 2
  },
  {
    ...
    correctAnswer: "A",
    explanation: "A <Switch> renders the first child <Route> that matches. A <Route> with no path always matches. So you just need to simply drop path attribute as below \ufffd\ufffd\ufffd Back to Top",
    ...
    hints: [
      "Consider the core principles and trade-offs of How to implement default or NotFound page?."
    ],
    source: "300-react",
    estimatedMinutes: 2
  },
  {
    ...
    correctAnswer: "A",
    explanation: "There are a few ways of binding action creators to dispatch() in mapDispatchToProps(). Below are the possible options: The third option is just a shorthand for the first one. \ufffd\ufffd\ufffd Back to Top",
    ...
    hints: [
      "Consider the core principles and trade-offs of What are the different ways to write mapDispatchToProps()?."
    ],
    source: "300-react",
    estimatedMinutes: 2
  },
  {
    ...
    correctAnswer: "A",
    explanation: "No. But you can try Hooks in a few components(or new components) without rewriting any existing code. Because there are no plans to remove classes in ReactJS. \ufffd\ufffd\ufffd Back to Top",
    ...
    hints: [
      "Consider the core principles and trade-offs of Do I need to rewrite all my class components with hooks?."
    ],
    source: "300-react",
    estimatedMinutes: 2
  },
  {
    ...
    correctAnswer: "A",
    explanation: "24 const HeavyChart = lazy ( ( ) = > import ( './charts/SalesChart' ) ) 25 const Dashboard = ( ) = > { 26 const [ show , setShow ] = useState ( false ) 27 return ( 28 < div > 29 < button onClick = { ( ) = > setShow ( true ) } > Show Analytics < / button > 30 { show & & ( 31 < Suspense fallback = { < ChartSkeleton / > } > 32 < HeavyChart / > 33 < / Suspense > 34 ) } 35 < / div > 36 ) 37 } 38 39 // Preload on hover (zero delay UX trick) 40 const preloadDashboard = ( ) = > import ( './pages/Dashboard' ) 41 < NavLink onMouseEnter = { preloadDashboard } to = '/dashboard' > Dashboard < / NavLink > n Interview Tip: Preload on hover \\227 when user hovers a navigation link, start downloading the chunk before they click. By the time they click, the chunk is already loaded. This gives you lazy loading benefits with zero perceived delay. Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn Frontend System Design | Comment 'FSD' for full PDF | Save \\267 Share \\267 Repost 6/42 nn FE Design",
    interviewLine: "Interview takeaway: Clearly articulate the underlying mechanism, lifecycle role, and performance trade-offs of How do you implement code splitting and lazy loading in a React app? n   Answer Code splitting breaks your bundle into smaller chunks loaded on demand. This reduces initial load time and only downloads code the user needs. Why code splitting matters: Default: all JS in one bundle \\227 user downloads everything on first load With splitting: user downloads only what they need for current page Result: 50-80% reduction in initial bundle size for large apps Three levels of code splitting: Route-level \\227 split by page \\(most impactful, easiest\\) Component-level \\227 split heavy components \\(charts, editors, modals\\) Library-level \\227 split third-party libraries \\(moment, lodash\\) React tools: React.lazy\\(\\) + Suspense \\227 built-in dynamic imports loadable-components \\227 SSR-compatible alternative Vite/webpack \\227 automatic chunk splitting What to lazy load: Heavy chart libraries \\(Recharts, D3, Chart.js\\) Rich text editors \\(TipTap, Quill, Monaco\\) Below-the-fold components Admin/settings pages  1 // Route-level code splitting \\(most important!\\)  2 import   {   lazy ,   Suspense   }   from   'react'  3 import   {   Routes ,   Route   }   from   'react-router-dom'  4  5 // Lazy import: NOT downloaded until user navigates here  6 const   Dashboard   =   lazy \\( \\( \\)   = >   import \\( './pages/Dashboard' \\) \\)  7 const   Analytics   =   lazy \\( \\( \\)   = >   import \\( './pages/Analytics' \\) \\)  8 const   Settings     =   lazy \\( \\( \\)   = >   import \\( './pages/Settings' \\) \\)  9 10 function   App \\( \\)   { 11     return   \\( 12         < Suspense   fallback = { < PageSkeleton   / > } > 13             < Routes > 14                 < Route   path = '/'   element = { < Home   / > }   / >                     // eager 15                 < Route   path = '/dashboard'   element = { < Dashboard   / > }   / >   // lazy 16                 < Route   path = '/analytics'   element = { < Analytics   / > }   / >   // lazy 17                 < Route   path = '/settings'     element = { < Settings   / > }     / >   // lazy 18             < / Routes > 19         < / Suspense > 20     \\) 21 } 22 23 // Component-level: heavy chart only when needed Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 6/42.",
    misconception: "Common misconception: misunderstanding the execution lifecycle, reactivity triggers, or edge cases of How do you implement code splitting and lazy loading in a React app? n   Answer Code splitting breaks your bundle into smaller chunks loaded on demand. This reduces initial load time and only downloads code the user needs. Why code splitting matters: Default: all JS in one bundle \\227 user downloads everything on first load With splitting: user downloads only what they need for current page Result: 50-80% reduction in initial bundle size for large apps Three levels of code splitting: Route-level \\227 split by page \\(most impactful, easiest\\) Component-level \\227 split heavy components \\(charts, editors, modals\\) Library-level \\227 split third-party libraries \\(moment, lodash\\) React tools: React.lazy\\(\\) + Suspense \\227 built-in dynamic imports loadable-components \\227 SSR-compatible alternative Vite/webpack \\227 automatic chunk splitting What to lazy load: Heavy chart libraries \\(Recharts, D3, Chart.js\\) Rich text editors \\(TipTap, Quill, Monaco\\) Below-the-fold components Admin/settings pages  1 // Route-level code splitting \\(most important!\\)  2 import   {   lazy ,   Suspense   }   from   'react'  3 import   {   Routes ,   Route   }   from   'react-router-dom'  4  5 // Lazy import: NOT downloaded until user navigates here  6 const   Dashboard   =   lazy \\( \\( \\)   = >   import \\( './pages/Dashboard' \\) \\)  7 const   Analytics   =   lazy \\( \\( \\)   = >   import \\( './pages/Analytics' \\) \\)  8 const   Settings     =   lazy \\( \\( \\)   = >   import \\( './pages/Settings' \\) \\)  9 10 function   App \\( \\)   { 11     return   \\( 12         < Suspense   fallback = { < PageSkeleton   / > } > 13             < Routes > 14                 < Route   path = '/'   element = { < Home   / > }   / >                     // eager 15                 < Route   path = '/dashboard'   element = { < Dashboard   / > }   / >   // lazy 16                 < Route   path = '/analytics'   element = { < Analytics   / > }   / >   // lazy 17                 < Route   path = '/settings'     element = { < Settings   / > }     / >   // lazy 18             < / Routes > 19         < / Suspense > 20     \\) 21 } 22 23 // Component-level: heavy chart only when needed Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 6/42.",
    hints: [
      "Consider the core principles and trade-offs of How do you implement code splitting and lazy loading in a React app? n   Answer Code splitting breaks your bundle into smaller chunks loaded on demand. This reduces initial load time and only downloads code the user needs. Why code splitting matters: Default: all JS in one bundle \\227 user downloads everything on first load With splitting: user downloads only what they need for current page Result: 50-80% reduction in initial bundle size for large apps Three levels of code splitting: Route-level \\227 split by page \\(most impactful, easiest\\) Component-level \\227 split heavy components \\(charts, editors, modals\\) Library-level \\227 split third-party libraries \\(moment, lodash\\) React tools: React.lazy\\(\\) + Suspense \\227 built-in dynamic imports loadable-components \\227 SSR-compatible alternative Vite/webpack \\227 automatic chunk splitting What to lazy load: Heavy chart libraries \\(Recharts, D3, Chart.js\\) Rich text editors \\(TipTap, Quill, Monaco\\) Below-the-fold components Admin/settings pages  1 // Route-level code splitting \\(most important!\\)  2 import   {   lazy ,   Suspense   }   from   'react'  3 import   {   Routes ,   Route   }   from   'react-router-dom'  4  5 // Lazy import: NOT downloaded until user navigates here  6 const   Dashboard   =   lazy \\( \\( \\)   = >   import \\( './pages/Dashboard' \\) \\)  7 const   Analytics   =   lazy \\( \\( \\)   = >   import \\( './pages/Analytics' \\) \\)  8 const   Settings     =   lazy \\( \\( \\)   = >   import \\( './pages/Settings' \\) \\)  9 10 function   App \\( \\)   { 11     return   \\( 12         < Suspense   fallback = { < PageSkeleton   / > } > 13             < Routes > 14                 < Route   path = '/'   element = { < Home   / > }   / >                     // eager 15                 < Route   path = '/dashboard'   element = { < Dashboard   / > }   / >   // lazy 16                 < Route   path = '/analytics'   element = { < Analytics   / > }   / >   // lazy 17                 < Route   path = '/settings'     element = { < Settings   / > }     / >   // lazy 18             < / Routes > 19         < / Suspense > 20     \\) 21 } 22 23 // Component-level: heavy chart only when needed Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 6/42."
    ],
  ...
  },
  {
    ...
    correctAnswer: "A",
    explanation: "30 { threshold : 0 . 1 } // trigger when 10% visible 31 ) 32 if ( sentinelRef . current ) observer . observe ( sentinelRef . current ) 33 return ( ) = > observer . disconnect ( ) 34 } , [ hasNextPage , isFetchingNextPage , fetchNextPage ] ) 35 36 // Flatten pages into single array 37 const posts = data ? . pages . flatMap ( page = > page . posts ) ? ? [ ] 38 39 return ( 40 < div > 41 { posts . map ( post = > < PostCard key = { post . id } post = { post } / > ) } 42 { isFetchingNextPage & & < SkeletonList count = { 3 } / > } 43 { ! hasNextPage & & < p > You are all caught up ! < / p > } 44 < div ref = { sentinelRef } style = { { height : 1 } } / > 45 < / div > 46 ) 47 } n Interview Tip: React Query's useInfiniteQuery automatically preserves scroll position. When user navigates away and comes back, the cached pages are still there and the scroll position is restored. This is a massive UX win that you get for free with the right state management choice. Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn Frontend System Design | Comment 'FSD' for full PDF | Save \\267 Share \\267 Repost 11/42 nn FE Design",
    interviewLine: "Interview takeaway: Clearly articulate the underlying mechanism, lifecycle role, and performance trade-offs of How do you implement infinite scroll with cursor-based pagination? n   Answer Infinite scroll loads the next page of data as user approaches the bottom of the list. Cursor-based pagination is more reliable than offset-based for real-time data. Cursor vs Offset pagination: Offset: page=2&limit=20 \\227 simple but breaks if items added mid-scroll Cursor: cursor=last_item_id&limit=20 \\227 stable, consistent, scalable Cursor is the industry standard for feeds \\(Twitter, Instagram, TikTok\\) Intersection Observer \\(no scroll event needed\\): Attach observer to a sentinel element at list bottom Fires when sentinel enters viewport Much more performant than scroll event listeners UX requirements: Skeleton loaders while fetching next page End-of-list message when no more data Scroll position preserved on back navigation \\(React Query handles this!\\)  1 // Infinite scroll with React Query + Intersection Observer  2 const   useFeed   =   \\( \\)   = >   {  3     return   useInfiniteQuery \\( {  4         queryKey :   [ 'feed' ] ,  5         queryFn :   \\( {   pageParam   } \\)   = >  6             api . getFeed \\( {   cursor :   pageParam ,   limit :   20   } \\) ,  7         initialPageParam :   null ,  8         getNextPageParam :   \\( lastPage \\)   = >  9             lastPage . nextCursor   ? ?   undefined ,     // undefined = no more pages 10     } \\) 11 } 12 13 const   Feed   =   \\( \\)   = >   { 14     const   { 15         data , 16         fetchNextPage , 17         hasNextPage , 18         isFetchingNextPage 19     }   =   useFeed \\( \\) 20 21     // Sentinel ref \\227 observe this element 22     const   sentinelRef   =   useRef \\( null \\) 23 24     useEffect \\( \\( \\)   = >   { 25         const   observer   =   new   IntersectionObserver \\( 26             \\( [ entry ] \\)   = >   { 27                 if   \\( entry . isIntersecting   & &   hasNextPage   & &   ! isFetchingNextPage \\) 28                     fetchNextPage \\( \\) 29             } , Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 11/42.",
    misconception: "Common misconception: misunderstanding the execution lifecycle, reactivity triggers, or edge cases of How do you implement infinite scroll with cursor-based pagination? n   Answer Infinite scroll loads the next page of data as user approaches the bottom of the list. Cursor-based pagination is more reliable than offset-based for real-time data. Cursor vs Offset pagination: Offset: page=2&limit=20 \\227 simple but breaks if items added mid-scroll Cursor: cursor=last_item_id&limit=20 \\227 stable, consistent, scalable Cursor is the industry standard for feeds \\(Twitter, Instagram, TikTok\\) Intersection Observer \\(no scroll event needed\\): Attach observer to a sentinel element at list bottom Fires when sentinel enters viewport Much more performant than scroll event listeners UX requirements: Skeleton loaders while fetching next page End-of-list message when no more data Scroll position preserved on back navigation \\(React Query handles this!\\)  1 // Infinite scroll with React Query + Intersection Observer  2 const   useFeed   =   \\( \\)   = >   {  3     return   useInfiniteQuery \\( {  4         queryKey :   [ 'feed' ] ,  5         queryFn :   \\( {   pageParam   } \\)   = >  6             api . getFeed \\( {   cursor :   pageParam ,   limit :   20   } \\) ,  7         initialPageParam :   null ,  8         getNextPageParam :   \\( lastPage \\)   = >  9             lastPage . nextCursor   ? ?   undefined ,     // undefined = no more pages 10     } \\) 11 } 12 13 const   Feed   =   \\( \\)   = >   { 14     const   { 15         data , 16         fetchNextPage , 17         hasNextPage , 18         isFetchingNextPage 19     }   =   useFeed \\( \\) 20 21     // Sentinel ref \\227 observe this element 22     const   sentinelRef   =   useRef \\( null \\) 23 24     useEffect \\( \\( \\)   = >   { 25         const   observer   =   new   IntersectionObserver \\( 26             \\( [ entry ] \\)   = >   { 27                 if   \\( entry . isIntersecting   & &   hasNextPage   & &   ! isFetchingNextPage \\) 28                     fetchNextPage \\( \\) 29             } , Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 11/42.",
    hints: [
      "Consider the core principles and trade-offs of How do you implement infinite scroll with cursor-based pagination? n   Answer Infinite scroll loads the next page of data as user approaches the bottom of the list. Cursor-based pagination is more reliable than offset-based for real-time data. Cursor vs Offset pagination: Offset: page=2&limit=20 \\227 simple but breaks if items added mid-scroll Cursor: cursor=last_item_id&limit=20 \\227 stable, consistent, scalable Cursor is the industry standard for feeds \\(Twitter, Instagram, TikTok\\) Intersection Observer \\(no scroll event needed\\): Attach observer to a sentinel element at list bottom Fires when sentinel enters viewport Much more performant than scroll event listeners UX requirements: Skeleton loaders while fetching next page End-of-list message when no more data Scroll position preserved on back navigation \\(React Query handles this!\\)  1 // Infinite scroll with React Query + Intersection Observer  2 const   useFeed   =   \\( \\)   = >   {  3     return   useInfiniteQuery \\( {  4         queryKey :   [ 'feed' ] ,  5         queryFn :   \\( {   pageParam   } \\)   = >  6             api . getFeed \\( {   cursor :   pageParam ,   limit :   20   } \\) ,  7         initialPageParam :   null ,  8         getNextPageParam :   \\( lastPage \\)   = >  9             lastPage . nextCursor   ? ?   undefined ,     // undefined = no more pages 10     } \\) 11 } 12 13 const   Feed   =   \\( \\)   = >   { 14     const   { 15         data , 16         fetchNextPage , 17         hasNextPage , 18         isFetchingNextPage 19     }   =   useFeed \\( \\) 20 21     // Sentinel ref \\227 observe this element 22     const   sentinelRef   =   useRef \\( null \\) 23 24     useEffect \\( \\( \\)   = >   { 25         const   observer   =   new   IntersectionObserver \\( 26             \\( [ entry ] \\)   = >   { 27                 if   \\( entry . isIntersecting   & &   hasNextPage   & &   ! isFetchingNextPage \\) 28                     fetchNextPage \\( \\) 29             } , Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 11/42."
    ],
    source: "frontend-system-design-50",
    estimatedMinutes: 4
  },
  {
    ...
    title: "How do you implement performance monitoring and error tracking in a frontend app? n   Answer Production monitoring catches issues users experience that you never see in dev. What to monitor: JavaScript errors \\227 unhandled exceptions and promise rejections Performance metrics \\227 Core Web Vitals, API response times User interactions \\227 clicks, form submissions, navigation timing Network requests \\227 failed API calls, slow endpoints Error tracking stack: Sentry \\227 industry standard, captures errors with stack traces, replays LogRocket \\227 session replay + errors Datadog RUM \\227 enterprise option Performance monitoring: Lighthouse CI \\227 automated perf testing in CI pipeline web-vitals library \\227 report CWV from real users Google Analytics 4 \\227 user behaviour Error boundary \\227 catch React render errors: Wraps component tree Shows fallback UI instead of blank white screen Reports error to Sentry  1 // Sentry setup  2 import   *   as   Sentry   from   '@sentry/react'  3 Sentry . init \\( {  4     dsn :   process . env . REACT_APP_SENTRY_DSN ,  5     environment :   process . env . NODE_ENV ,  6     tracesSampleRate :   0 . 1 ,         // 10% of transactions  7     replaysSessionSampleRate :   0 . 01 ,     // 1% session replay  8     integrations :   [ Sentry . browserTracingIntegration \\( \\) ] ,  9 } \\) 10 11 // Error Boundary: catch render errors 12 class   ErrorBoundary   extends   React . Component   { 13     state   =   {   hasError :   false ,   error :   null   } 14 15     static   getDerivedStateFromError \\( error \\)   { 16         return   {   hasError :   true ,   error   } 17     } 18 19     componentDidCatch \\( error ,   info \\)   { 20         Sentry . captureException \\( error ,   {   extra :   info   } \\) 21     } 22 23     render \\( \\)   { 24         if   \\( this . state . hasError \\) Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 14/42",
    prompt: "How do you implement performance monitoring and error tracking in a frontend app? n   Answer Production monitoring catches issues users experience that you never see in dev. What to monitor: JavaScript errors \\227 unhandled exceptions and promise rejections Performance metrics \\227 Core Web Vitals, API response times User interactions \\227 clicks, form submissions, navigation timing Network requests \\227 failed API calls, slow endpoints Error tracking stack: Sentry \\227 industry standard, captures errors with stack traces, replays LogRocket \\227 session replay + errors Datadog RUM \\227 enterprise option Performance monitoring: Lighthouse CI \\227 automated perf testing in CI pipeline web-vitals library \\227 report CWV from real users Google Analytics 4 \\227 user behaviour Error boundary \\227 catch React render errors: Wraps component tree Shows fallback UI instead of blank white screen Reports error to Sentry  1 // Sentry setup  2 import   *   as   Sentry   from   '@sentry/react'  3 Sentry . init \\( {  4     dsn :   process . env . REACT_APP_SENTRY_DSN ,  5     environment :   process . env . NODE_ENV ,  6     tracesSampleRate :   0 . 1 ,         // 10% of transactions  7     replaysSessionSampleRate :   0 . 01 ,     // 1% session replay  8     integrations :   [ Sentry . browserTracingIntegration \\( \\) ] ,  9 } \\) 10 11 // Error Boundary: catch render errors 12 class   ErrorBoundary   extends   React . Component   { 13     state   =   {   hasError :   false ,   error :   null   } 14 15     static   getDerivedStateFromError \\( error \\)   { 16         return   {   hasError :   true ,   error   } 17     } 18 19     componentDidCatch \\( error ,   info \\)   { 20         Sentry . captureException \\( error ,   {   extra :   info   } \\) 21     } 22 23     render \\( \\)   { 24         if   \\( this . state . hasError \\) Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 14/42",
    level: "senior",
    type: "live_code",
    category: "system_design",
    subject: "rendering-keys",
    ...
    correctAnswer: "A",
    explanation: "25 return < ErrorFallback onReset = { ( ) = > this . setState ( { hasError : false } ) } / > 26 return this . props . children 27 } 28 } 29 30 // Custom error tracking for API failures 31 const api = axios . create ( { baseURL : '/api' } ) 32 api . interceptors . response . use ( 33 res = > res , 34 error = > { 35 Sentry . captureException ( error , { 36 tags : { api_url : error . config . url } , 37 extra : { status : error . response ? . status } 38 } ) 39 return Promise . reject ( error ) 40 } 41 ) n Interview Tip: Deploy Sentry on day 1, not after the first production outage. Unhandled errors in production are invisible without error tracking \\227 you find out from angry users, not your monitoring. Sentry's free tier covers most small-to-medium apps completely. Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn Frontend System Design | Comment 'FSD' for full PDF | Save \\267 Share \\267 Repost 14/42 nn FE Design",
    interviewLine: "Interview takeaway: Clearly articulate the underlying mechanism, lifecycle role, and performance trade-offs of How do you implement performance monitoring and error tracking in a frontend app? n   Answer Production monitoring catches issues users experience that you never see in dev. What to monitor: JavaScript errors \\227 unhandled exceptions and promise rejections Performance metrics \\227 Core Web Vitals, API response times User interactions \\227 clicks, form submissions, navigation timing Network requests \\227 failed API calls, slow endpoints Error tracking stack: Sentry \\227 industry standard, captures errors with stack traces, replays LogRocket \\227 session replay + errors Datadog RUM \\227 enterprise option Performance monitoring: Lighthouse CI \\227 automated perf testing in CI pipeline web-vitals library \\227 report CWV from real users Google Analytics 4 \\227 user behaviour Error boundary \\227 catch React render errors: Wraps component tree Shows fallback UI instead of blank white screen Reports error to Sentry  1 // Sentry setup  2 import   *   as   Sentry   from   '@sentry/react'  3 Sentry . init \\( {  4     dsn :   process . env . REACT_APP_SENTRY_DSN ,  5     environment :   process . env . NODE_ENV ,  6     tracesSampleRate :   0 . 1 ,         // 10% of transactions  7     replaysSessionSampleRate :   0 . 01 ,     // 1% session replay  8     integrations :   [ Sentry . browserTracingIntegration \\( \\) ] ,  9 } \\) 10 11 // Error Boundary: catch render errors 12 class   ErrorBoundary   extends   React . Component   { 13     state   =   {   hasError :   false ,   error :   null   } 14 15     static   getDerivedStateFromError \\( error \\)   { 16         return   {   hasError :   true ,   error   } 17     } 18 19     componentDidCatch \\( error ,   info \\)   { 20         Sentry . captureException \\( error ,   {   extra :   info   } \\) 21     } 22 23     render \\( \\)   { 24         if   \\( this . state . hasError \\) Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 14/42.",
    misconception: "Common misconception: misunderstanding the execution lifecycle, reactivity triggers, or edge cases of How do you implement performance monitoring and error tracking in a frontend app? n   Answer Production monitoring catches issues users experience that you never see in dev. What to monitor: JavaScript errors \\227 unhandled exceptions and promise rejections Performance metrics \\227 Core Web Vitals, API response times User interactions \\227 clicks, form submissions, navigation timing Network requests \\227 failed API calls, slow endpoints Error tracking stack: Sentry \\227 industry standard, captures errors with stack traces, replays LogRocket \\227 session replay + errors Datadog RUM \\227 enterprise option Performance monitoring: Lighthouse CI \\227 automated perf testing in CI pipeline web-vitals library \\227 report CWV from real users Google Analytics 4 \\227 user behaviour Error boundary \\227 catch React render errors: Wraps component tree Shows fallback UI instead of blank white screen Reports error to Sentry  1 // Sentry setup  2 import   *   as   Sentry   from   '@sentry/react'  3 Sentry . init \\( {  4     dsn :   process . env . REACT_APP_SENTRY_DSN ,  5     environment :   process . env . NODE_ENV ,  6     tracesSampleRate :   0 . 1 ,         // 10% of transactions  7     replaysSessionSampleRate :   0 . 01 ,     // 1% session replay  8     integrations :   [ Sentry . browserTracingIntegration \\( \\) ] ,  9 } \\) 10 11 // Error Boundary: catch render errors 12 class   ErrorBoundary   extends   React . Component   { 13     state   =   {   hasError :   false ,   error :   null   } 14 15     static   getDerivedStateFromError \\( error \\)   { 16         return   {   hasError :   true ,   error   } 17     } 18 19     componentDidCatch \\( error ,   info \\)   { 20         Sentry . captureException \\( error ,   {   extra :   info   } \\) 21     } 22 23     render \\( \\)   { 24         if   \\( this . state . hasError \\) Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 14/42.",
    hints: [
      "Consider the core principles and trade-offs of How do you implement performance monitoring and error tracking in a frontend app? n   Answer Production monitoring catches issues users experience that you never see in dev. What to monitor: JavaScript errors \\227 unhandled exceptions and promise rejections Performance metrics \\227 Core Web Vitals, API response times User interactions \\227 clicks, form submissions, navigation timing Network requests \\227 failed API calls, slow endpoints Error tracking stack: Sentry \\227 industry standard, captures errors with stack traces, replays LogRocket \\227 session replay + errors Datadog RUM \\227 enterprise option Performance monitoring: Lighthouse CI \\227 automated perf testing in CI pipeline web-vitals library \\227 report CWV from real users Google Analytics 4 \\227 user behaviour Error boundary \\227 catch React render errors: Wraps component tree Shows fallback UI instead of blank white screen Reports error to Sentry  1 // Sentry setup  2 import   *   as   Sentry   from   '@sentry/react'  3 Sentry . init \\( {  4     dsn :   process . env . REACT_APP_SENTRY_DSN ,  5     environment :   process . env . NODE_ENV ,  6     tracesSampleRate :   0 . 1 ,         // 10% of transactions  7     replaysSessionSampleRate :   0 . 01 ,     // 1% session replay  8     integrations :   [ Sentry . browserTracingIntegration \\( \\) ] ,  9 } \\) 10 11 // Error Boundary: catch render errors 12 class   ErrorBoundary   extends   React . Component   { 13     state   =   {   hasError :   false ,   error :   null   } 14 15     static   getDerivedStateFromError \\( error \\)   { 16         return   {   hasError :   true ,   error   } 17     } 18 19     componentDidCatch \\( error ,   info \\)   { 20         Sentry . captureException \\( error ,   {   extra :   info   } \\) 21     } 22 23     render \\( \\)   { 24         if   \\( this . state . hasError \\) Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 14/42."
    ],
    source: "frontend-system-design-50",
    estimatedMinutes: 4
  },
  {
    ...
    title: "How do you implement frontend security \\227 XSS, CSRF, CSP? n   Answer Frontend security prevents attackers from stealing data, hijacking sessions, and injecting malicious code. XSS \\(Cross-Site Scripting\\): Attacker injects malicious JS into your page React escapes HTML by default \\227 dangerouslySetInnerHTML is dangerous! Sanitize user input before rendering as HTML \\(DOMPurify\\) HttpOnly cookies prevent token theft via XSS CSRF \\(Cross-Site Request Forgery\\): Attacker tricks user's browser into making authenticated requests Prevention: SameSite=Strict cookies + CSRF tokens for mutations Content Security Policy \\(CSP\\): HTTP header that tells browser which sources are allowed Blocks inline scripts, eval\\(\\), external scripts Most powerful XSS defence Other frontend security essentials: HTTPS everywhere \\227 HTTP Strict Transport Security header Subresource Integrity \\227 verify CDN scripts not tampered Referrer Policy \\227 don't leak URL in referrer header  1 // XSS: dangerous pattern vs safe pattern  2 // NEVER do this with user content:  3 // <div dangerouslySetInnerHTML={{ __html: userBio }} />  4  5 // SAFE: sanitize with DOMPurify first  6 import   DOMPurify   from   'dompurify'  7 const   SafeHtml   =   \\( {   html   } \\)   = >   \\(  8     < div   dangerouslySetInnerHTML = { {  9         __html :   DOMPurify . sanitize \\( html ,   {   ALLOWED_TAGS :   [ 'b' , 'i' , 'a' , 'p' ]   } \\) 10     } }   / > 11 \\) 12 13 // CSP header \\(set in server response or Next.js headers\\) 14 // Content-Security-Policy: 15 //   default-src 'self';                 only same origin 16 //   script-src 'self' cdn.myapp.com;    allow CDN scripts 17 //   style-src 'self' 'nonce-abc123';    allow nonce-tagged styles 18 //   img-src 'self' data: https:;        allow images from HTTPS 19 //   frame-ancestors 'none';             prevent clickjacking 20 21 // Next.js: CSP via headers in next.config.js 22 const   csp   =   [ 23     `default-src 'self'` , 24     `script-src 'self' 'nonce-${nonce}'` , 25     `style-src 'self' 'unsafe-inline'` , Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 17/42",
    prompt: "How do you implement frontend security \\227 XSS, CSRF, CSP? n   Answer Frontend security prevents attackers from stealing data, hijacking sessions, and injecting malicious code. XSS \\(Cross-Site Scripting\\): Attacker injects malicious JS into your page React escapes HTML by default \\227 dangerouslySetInnerHTML is dangerous! Sanitize user input before rendering as HTML \\(DOMPurify\\) HttpOnly cookies prevent token theft via XSS CSRF \\(Cross-Site Request Forgery\\): Attacker tricks user's browser into making authenticated requests Prevention: SameSite=Strict cookies + CSRF tokens for mutations Content Security Policy \\(CSP\\): HTTP header that tells browser which sources are allowed Blocks inline scripts, eval\\(\\), external scripts Most powerful XSS defence Other frontend security essentials: HTTPS everywhere \\227 HTTP Strict Transport Security header Subresource Integrity \\227 verify CDN scripts not tampered Referrer Policy \\227 don't leak URL in referrer header  1 // XSS: dangerous pattern vs safe pattern  2 // NEVER do this with user content:  3 // <div dangerouslySetInnerHTML={{ __html: userBio }} />  4  5 // SAFE: sanitize with DOMPurify first  6 import   DOMPurify   from   'dompurify'  7 const   SafeHtml   =   \\( {   html   } \\)   = >   \\(  8     < div   dangerouslySetInnerHTML = { {  9         __html :   DOMPurify . sanitize \\( html ,   {   ALLOWED_TAGS :   [ 'b' , 'i' , 'a' , 'p' ]   } \\) 10     } }   / > 11 \\) 12 13 // CSP header \\(set in server response or Next.js headers\\) 14 // Content-Security-Policy: 15 //   default-src 'self';                 only same origin 16 //   script-src 'self' cdn.myapp.com;    allow CDN scripts 17 //   style-src 'self' 'nonce-abc123';    allow nonce-tagged styles 18 //   img-src 'self' data: https:;        allow images from HTTPS 19 //   frame-ancestors 'none';             prevent clickjacking 20 21 // Next.js: CSP via headers in next.config.js 22 const   csp   =   [ 23     `default-src 'self'` , 24     `script-src 'self' 'nonce-${nonce}'` , 25     `style-src 'self' 'unsafe-inline'` , Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 17/42",
    level: "senior",
    type: "live_code",
    category: "nextjs",
    subject: "rendering-keys",
    ...
    options: [
      {
        id: "A",
        text: "How do you implement frontend security \\227 XSS, CSRF, CSP? n   Answer Frontend security prevents attackers from stealing data, hijacking sessions, and injecting malicious code. XSS \\(Cross-Site Scripting\\): Attacker injects malicious JS into your page React escapes HTML by default \\227 dangerouslySetInnerHTML is dangerous! Sanitize user input before rendering as HTML \\(DOMPurify\\) HttpOnly cookies prevent token theft via XSS CSRF \\(Cross-Site Request Forgery\\): Attacker tricks user's browser into making authenticated requests Prevention: SameSite=Strict cookies + CSRF tokens for mutations Content Security Policy \\(CSP\\): HTTP header that tells browser which sources are allowed Blocks inline scripts, eval\\(\\), external scripts Most powerful XSS defence Other frontend security essentials: HTTPS everywhere \\227 HTTP Strict Transport Security header Subresource Integrity \\227 verify CDN scripts not tampered Referrer Policy \\227 don't leak URL in referrer header  1 // XSS: dangerous pattern vs safe pattern  2 // NEVER do this with user content:  3 // <div dangerouslySetInnerHTML={{ __html: userBio }} />  4  5 // SAFE: sanitize with DOMPurify first  6 import   DOMPurify   from   'dompurify'  7 const   SafeHtml   =   \\( {   html   } \\)   = >   \\(  8     < div   dangerouslySetInnerHTML = { {  9         __html :   DOMPurify . sanitize \\( html ,   {   ALLOWED_TAGS :   [ 'b' , 'i' , 'a' , 'p' ]   } \\) 10     } }   / > 11 \\) 12 13 // CSP header \\(set in server response or Next.js headers\\) 14 // Content-Security-Policy: 15 //   default-src 'self';                 only same origin 16 //   script-src 'self' cdn.myapp.com;    allow CDN scripts 17 //   style-src 'self' 'nonce-abc123';    allow nonce-tagged styles 18 //   img-src 'self' data: https:;        allow images from HTTPS 19 //   frame-ancestors 'none';             prevent clickjacking 20 21 // Next.js: CSP via headers in next.config.js 22 const   csp   =   [ 23     `default-src 'self'` , 24     `script-src 'self' 'nonce-${nonce}'` , 25     `style-src 'self' 'unsafe-inline'` , Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 17/42: Core React and frontend architecture principle.",
        isCorrect: true,
        explanation: "Correct: aligns with standard React, JavaScript, and algorithm principles."
      },
      {
    ...
    correctAnswer: "A",
    explanation: "26 ] . join ( '; ' ) 27 28 // Subresource Integrity (SRI) 29 // <script src='https://cdn.../react.js' 30 // integrity='sha384-abc...' 31 // crossorigin='anonymous'></script> 32 33 // CSRF: SameSite cookie 34 // Set-Cookie: session=xxx; HttpOnly; Secure; SameSite=Strict n Interview Tip: Content Security Policy is your strongest XSS defence. Even if an attacker injects a script tag, CSP blocks it from executing. Add a nonce to every inline script and enforce script-src with your nonce. This blocks most XSS attacks even if sanitization misses something. Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn Frontend System Design | Comment 'FSD' for full PDF | Save \\267 Share \\267 Repost 17/42 nn FE Design",
    interviewLine: "Interview takeaway: Clearly articulate the underlying mechanism, lifecycle role, and performance trade-offs of How do you implement frontend security \\227 XSS, CSRF, CSP? n   Answer Frontend security prevents attackers from stealing data, hijacking sessions, and injecting malicious code. XSS \\(Cross-Site Scripting\\): Attacker injects malicious JS into your page React escapes HTML by default \\227 dangerouslySetInnerHTML is dangerous! Sanitize user input before rendering as HTML \\(DOMPurify\\) HttpOnly cookies prevent token theft via XSS CSRF \\(Cross-Site Request Forgery\\): Attacker tricks user's browser into making authenticated requests Prevention: SameSite=Strict cookies + CSRF tokens for mutations Content Security Policy \\(CSP\\): HTTP header that tells browser which sources are allowed Blocks inline scripts, eval\\(\\), external scripts Most powerful XSS defence Other frontend security essentials: HTTPS everywhere \\227 HTTP Strict Transport Security header Subresource Integrity \\227 verify CDN scripts not tampered Referrer Policy \\227 don't leak URL in referrer header  1 // XSS: dangerous pattern vs safe pattern  2 // NEVER do this with user content:  3 // <div dangerouslySetInnerHTML={{ __html: userBio }} />  4  5 // SAFE: sanitize with DOMPurify first  6 import   DOMPurify   from   'dompurify'  7 const   SafeHtml   =   \\( {   html   } \\)   = >   \\(  8     < div   dangerouslySetInnerHTML = { {  9         __html :   DOMPurify . sanitize \\( html ,   {   ALLOWED_TAGS :   [ 'b' , 'i' , 'a' , 'p' ]   } \\) 10     } }   / > 11 \\) 12 13 // CSP header \\(set in server response or Next.js headers\\) 14 // Content-Security-Policy: 15 //   default-src 'self';                 only same origin 16 //   script-src 'self' cdn.myapp.com;    allow CDN scripts 17 //   style-src 'self' 'nonce-abc123';    allow nonce-tagged styles 18 //   img-src 'self' data: https:;        allow images from HTTPS 19 //   frame-ancestors 'none';             prevent clickjacking 20 21 // Next.js: CSP via headers in next.config.js 22 const   csp   =   [ 23     `default-src 'self'` , 24     `script-src 'self' 'nonce-${nonce}'` , 25     `style-src 'self' 'unsafe-inline'` , Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 17/42.",
    misconception: "Common misconception: misunderstanding the execution lifecycle, reactivity triggers, or edge cases of How do you implement frontend security \\227 XSS, CSRF, CSP? n   Answer Frontend security prevents attackers from stealing data, hijacking sessions, and injecting malicious code. XSS \\(Cross-Site Scripting\\): Attacker injects malicious JS into your page React escapes HTML by default \\227 dangerouslySetInnerHTML is dangerous! Sanitize user input before rendering as HTML \\(DOMPurify\\) HttpOnly cookies prevent token theft via XSS CSRF \\(Cross-Site Request Forgery\\): Attacker tricks user's browser into making authenticated requests Prevention: SameSite=Strict cookies + CSRF tokens for mutations Content Security Policy \\(CSP\\): HTTP header that tells browser which sources are allowed Blocks inline scripts, eval\\(\\), external scripts Most powerful XSS defence Other frontend security essentials: HTTPS everywhere \\227 HTTP Strict Transport Security header Subresource Integrity \\227 verify CDN scripts not tampered Referrer Policy \\227 don't leak URL in referrer header  1 // XSS: dangerous pattern vs safe pattern  2 // NEVER do this with user content:  3 // <div dangerouslySetInnerHTML={{ __html: userBio }} />  4  5 // SAFE: sanitize with DOMPurify first  6 import   DOMPurify   from   'dompurify'  7 const   SafeHtml   =   \\( {   html   } \\)   = >   \\(  8     < div   dangerouslySetInnerHTML = { {  9         __html :   DOMPurify . sanitize \\( html ,   {   ALLOWED_TAGS :   [ 'b' , 'i' , 'a' , 'p' ]   } \\) 10     } }   / > 11 \\) 12 13 // CSP header \\(set in server response or Next.js headers\\) 14 // Content-Security-Policy: 15 //   default-src 'self';                 only same origin 16 //   script-src 'self' cdn.myapp.com;    allow CDN scripts 17 //   style-src 'self' 'nonce-abc123';    allow nonce-tagged styles 18 //   img-src 'self' data: https:;        allow images from HTTPS 19 //   frame-ancestors 'none';             prevent clickjacking 20 21 // Next.js: CSP via headers in next.config.js 22 const   csp   =   [ 23     `default-src 'self'` , 24     `script-src 'self' 'nonce-${nonce}'` , 25     `style-src 'self' 'unsafe-inline'` , Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 17/42.",
    hints: [
      "Consider the core principles and trade-offs of How do you implement frontend security \\227 XSS, CSRF, CSP? n   Answer Frontend security prevents attackers from stealing data, hijacking sessions, and injecting malicious code. XSS \\(Cross-Site Scripting\\): Attacker injects malicious JS into your page React escapes HTML by default \\227 dangerouslySetInnerHTML is dangerous! Sanitize user input before rendering as HTML \\(DOMPurify\\) HttpOnly cookies prevent token theft via XSS CSRF \\(Cross-Site Request Forgery\\): Attacker tricks user's browser into making authenticated requests Prevention: SameSite=Strict cookies + CSRF tokens for mutations Content Security Policy \\(CSP\\): HTTP header that tells browser which sources are allowed Blocks inline scripts, eval\\(\\), external scripts Most powerful XSS defence Other frontend security essentials: HTTPS everywhere \\227 HTTP Strict Transport Security header Subresource Integrity \\227 verify CDN scripts not tampered Referrer Policy \\227 don't leak URL in referrer header  1 // XSS: dangerous pattern vs safe pattern  2 // NEVER do this with user content:  3 // <div dangerouslySetInnerHTML={{ __html: userBio }} />  4  5 // SAFE: sanitize with DOMPurify first  6 import   DOMPurify   from   'dompurify'  7 const   SafeHtml   =   \\( {   html   } \\)   = >   \\(  8     < div   dangerouslySetInnerHTML = { {  9         __html :   DOMPurify . sanitize \\( html ,   {   ALLOWED_TAGS :   [ 'b' , 'i' , 'a' , 'p' ]   } \\) 10     } }   / > 11 \\) 12 13 // CSP header \\(set in server response or Next.js headers\\) 14 // Content-Security-Policy: 15 //   default-src 'self';                 only same origin 16 //   script-src 'self' cdn.myapp.com;    allow CDN scripts 17 //   style-src 'self' 'nonce-abc123';    allow nonce-tagged styles 18 //   img-src 'self' data: https:;        allow images from HTTPS 19 //   frame-ancestors 'none';             prevent clickjacking 20 21 // Next.js: CSP via headers in next.config.js 22 const   csp   =   [ 23     `default-src 'self'` , 24     `script-src 'self' 'nonce-${nonce}'` , 25     `style-src 'self' 'unsafe-inline'` , Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 17/42."
    ],
    source: "frontend-system-design-50",
    estimatedMinutes: 4
  },
  {
    ...
    title: "How do you implement optimistic UI updates? n   Answer Optimistic updates update the UI immediately before server confirmation, making the app feel instantaneous even with slow networks. How optimistic updates work: User performs action \\(like, comment, delete\\) UI updates immediately \\(don't wait for server\\) API call made in background If API succeeds \\227 nothing to do, UI already correct If API fails \\227 rollback UI to previous state, show error Where to use: Like / upvote / reactions \\227 user expects instant feedback Mark as read \\227 should feel instant Delete items \\227 remove immediately, undo if server fails Follow/unfollow \\227 button should toggle instantly Where NOT to use: Payments \\227 never fake success for financial transactions Complex mutations with side effects you can't predict When rollback UX would be confusing  1 // Pattern 1: React Query optimistic update \\(recommended\\)  2 const   useToggleLike   =   \\( \\)   = >   {  3     const   queryClient   =   useQueryClient \\( \\)  4     return   useMutation \\( {  5         mutationFn :   \\( postId \\)   = >   api . toggleLike \\( postId \\) ,  6         onMutate :   async   \\( postId \\)   = >   {  7             // Cancel any outgoing refetches  8             await   queryClient . cancelQueries \\( {   queryKey :   [ 'posts' ]   } \\)  9             // Snapshot for rollback 10             const   prevPosts   =   queryClient . getQueryData \\( [ 'posts' ] \\) 11             // Optimistic update \\227 toggle like immediately 12             queryClient . setQueryData \\( [ 'posts' ] ,   old   = >   old . map \\( p   = > 13                 p . id   = = =   postId 14                     ?   {   . . . p ,   liked :   ! p . liked ,   likeCount :   p . likeCount   +   \\( p . liked   ?   - 1   :   1 \\)   } 15                     :   p 16             \\) \\) 17             return   {   prevPosts   }     // pass snapshot to onError 18         } , 19         onError :   \\( err ,   postId ,   context \\)   = >   { 20             // Rollback to snapshot 21             queryClient . setQueryData \\( [ 'posts' ] ,   context . prevPosts \\) 22             toast . error \\( 'Failed to like post. Please try again.' \\) 23         } , 24         onSettled :   \\( \\)   = >   { 25             // Always sync with server when done 26             queryClient . invalidateQueries \\( {   queryKey :   [ 'posts' ]   } \\) Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 26/42",
    prompt: "How do you implement optimistic UI updates? n   Answer Optimistic updates update the UI immediately before server confirmation, making the app feel instantaneous even with slow networks. How optimistic updates work: User performs action \\(like, comment, delete\\) UI updates immediately \\(don't wait for server\\) API call made in background If API succeeds \\227 nothing to do, UI already correct If API fails \\227 rollback UI to previous state, show error Where to use: Like / upvote / reactions \\227 user expects instant feedback Mark as read \\227 should feel instant Delete items \\227 remove immediately, undo if server fails Follow/unfollow \\227 button should toggle instantly Where NOT to use: Payments \\227 never fake success for financial transactions Complex mutations with side effects you can't predict When rollback UX would be confusing  1 // Pattern 1: React Query optimistic update \\(recommended\\)  2 const   useToggleLike   =   \\( \\)   = >   {  3     const   queryClient   =   useQueryClient \\( \\)  4     return   useMutation \\( {  5         mutationFn :   \\( postId \\)   = >   api . toggleLike \\( postId \\) ,  6         onMutate :   async   \\( postId \\)   = >   {  7             // Cancel any outgoing refetches  8             await   queryClient . cancelQueries \\( {   queryKey :   [ 'posts' ]   } \\)  9             // Snapshot for rollback 10             const   prevPosts   =   queryClient . getQueryData \\( [ 'posts' ] \\) 11             // Optimistic update \\227 toggle like immediately 12             queryClient . setQueryData \\( [ 'posts' ] ,   old   = >   old . map \\( p   = > 13                 p . id   = = =   postId 14                     ?   {   . . . p ,   liked :   ! p . liked ,   likeCount :   p . likeCount   +   \\( p . liked   ?   - 1   :   1 \\)   } 15                     :   p 16             \\) \\) 17             return   {   prevPosts   }     // pass snapshot to onError 18         } , 19         onError :   \\( err ,   postId ,   context \\)   = >   { 20             // Rollback to snapshot 21             queryClient . setQueryData \\( [ 'posts' ] ,   context . prevPosts \\) 22             toast . error \\( 'Failed to like post. Please try again.' \\) 23         } , 24         onSettled :   \\( \\)   = >   { 25             // Always sync with server when done 26             queryClient . invalidateQueries \\( {   queryKey :   [ 'posts' ]   } \\) Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 26/42",
    level: "senior",
    type: "live_code",
    category: "system_design",
    subject: "hooks",
    ...
    correctAnswer: "A",
    explanation: "27 } 28 } ) 29 } 30 31 // Pattern 2: Manual optimistic update 32 const [ localLiked , setLocalLiked ] = useState ( post . liked ) 33 const handleLike = async ( ) = > { 34 setLocalLiked ( prev = > ! prev ) // instant UI 35 try { 36 await api . toggleLike ( post . id ) 37 } catch { 38 setLocalLiked ( post . liked ) // rollback on error 39 toast . error ( 'Failed to like' ) 40 } 41 } n Interview Tip: The rollback UX matters as much as the optimistic update. When the API fails, you must clearly communicate to the user that the action failed and the UI has been reverted. Silent rollbacks confuse users who don't understand why their action un-happened. Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn Frontend System Design | Comment 'FSD' for full PDF | Save \\267 Share \\267 Repost 26/42 nn FE Design",
    interviewLine: "Interview takeaway: Clearly articulate the underlying mechanism, lifecycle role, and performance trade-offs of How do you implement optimistic UI updates? n   Answer Optimistic updates update the UI immediately before server confirmation, making the app feel instantaneous even with slow networks. How optimistic updates work: User performs action \\(like, comment, delete\\) UI updates immediately \\(don't wait for server\\) API call made in background If API succeeds \\227 nothing to do, UI already correct If API fails \\227 rollback UI to previous state, show error Where to use: Like / upvote / reactions \\227 user expects instant feedback Mark as read \\227 should feel instant Delete items \\227 remove immediately, undo if server fails Follow/unfollow \\227 button should toggle instantly Where NOT to use: Payments \\227 never fake success for financial transactions Complex mutations with side effects you can't predict When rollback UX would be confusing  1 // Pattern 1: React Query optimistic update \\(recommended\\)  2 const   useToggleLike   =   \\( \\)   = >   {  3     const   queryClient   =   useQueryClient \\( \\)  4     return   useMutation \\( {  5         mutationFn :   \\( postId \\)   = >   api . toggleLike \\( postId \\) ,  6         onMutate :   async   \\( postId \\)   = >   {  7             // Cancel any outgoing refetches  8             await   queryClient . cancelQueries \\( {   queryKey :   [ 'posts' ]   } \\)  9             // Snapshot for rollback 10             const   prevPosts   =   queryClient . getQueryData \\( [ 'posts' ] \\) 11             // Optimistic update \\227 toggle like immediately 12             queryClient . setQueryData \\( [ 'posts' ] ,   old   = >   old . map \\( p   = > 13                 p . id   = = =   postId 14                     ?   {   . . . p ,   liked :   ! p . liked ,   likeCount :   p . likeCount   +   \\( p . liked   ?   - 1   :   1 \\)   } 15                     :   p 16             \\) \\) 17             return   {   prevPosts   }     // pass snapshot to onError 18         } , 19         onError :   \\( err ,   postId ,   context \\)   = >   { 20             // Rollback to snapshot 21             queryClient . setQueryData \\( [ 'posts' ] ,   context . prevPosts \\) 22             toast . error \\( 'Failed to like post. Please try again.' \\) 23         } , 24         onSettled :   \\( \\)   = >   { 25             // Always sync with server when done 26             queryClient . invalidateQueries \\( {   queryKey :   [ 'posts' ]   } \\) Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 26/42.",
    misconception: "Common misconception: misunderstanding the execution lifecycle, reactivity triggers, or edge cases of How do you implement optimistic UI updates? n   Answer Optimistic updates update the UI immediately before server confirmation, making the app feel instantaneous even with slow networks. How optimistic updates work: User performs action \\(like, comment, delete\\) UI updates immediately \\(don't wait for server\\) API call made in background If API succeeds \\227 nothing to do, UI already correct If API fails \\227 rollback UI to previous state, show error Where to use: Like / upvote / reactions \\227 user expects instant feedback Mark as read \\227 should feel instant Delete items \\227 remove immediately, undo if server fails Follow/unfollow \\227 button should toggle instantly Where NOT to use: Payments \\227 never fake success for financial transactions Complex mutations with side effects you can't predict When rollback UX would be confusing  1 // Pattern 1: React Query optimistic update \\(recommended\\)  2 const   useToggleLike   =   \\( \\)   = >   {  3     const   queryClient   =   useQueryClient \\( \\)  4     return   useMutation \\( {  5         mutationFn :   \\( postId \\)   = >   api . toggleLike \\( postId \\) ,  6         onMutate :   async   \\( postId \\)   = >   {  7             // Cancel any outgoing refetches  8             await   queryClient . cancelQueries \\( {   queryKey :   [ 'posts' ]   } \\)  9             // Snapshot for rollback 10             const   prevPosts   =   queryClient . getQueryData \\( [ 'posts' ] \\) 11             // Optimistic update \\227 toggle like immediately 12             queryClient . setQueryData \\( [ 'posts' ] ,   old   = >   old . map \\( p   = > 13                 p . id   = = =   postId 14                     ?   {   . . . p ,   liked :   ! p . liked ,   likeCount :   p . likeCount   +   \\( p . liked   ?   - 1   :   1 \\)   } 15                     :   p 16             \\) \\) 17             return   {   prevPosts   }     // pass snapshot to onError 18         } , 19         onError :   \\( err ,   postId ,   context \\)   = >   { 20             // Rollback to snapshot 21             queryClient . setQueryData \\( [ 'posts' ] ,   context . prevPosts \\) 22             toast . error \\( 'Failed to like post. Please try again.' \\) 23         } , 24         onSettled :   \\( \\)   = >   { 25             // Always sync with server when done 26             queryClient . invalidateQueries \\( {   queryKey :   [ 'posts' ]   } \\) Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 26/42.",
    hints: [
      "Consider the core principles and trade-offs of How do you implement optimistic UI updates? n   Answer Optimistic updates update the UI immediately before server confirmation, making the app feel instantaneous even with slow networks. How optimistic updates work: User performs action \\(like, comment, delete\\) UI updates immediately \\(don't wait for server\\) API call made in background If API succeeds \\227 nothing to do, UI already correct If API fails \\227 rollback UI to previous state, show error Where to use: Like / upvote / reactions \\227 user expects instant feedback Mark as read \\227 should feel instant Delete items \\227 remove immediately, undo if server fails Follow/unfollow \\227 button should toggle instantly Where NOT to use: Payments \\227 never fake success for financial transactions Complex mutations with side effects you can't predict When rollback UX would be confusing  1 // Pattern 1: React Query optimistic update \\(recommended\\)  2 const   useToggleLike   =   \\( \\)   = >   {  3     const   queryClient   =   useQueryClient \\( \\)  4     return   useMutation \\( {  5         mutationFn :   \\( postId \\)   = >   api . toggleLike \\( postId \\) ,  6         onMutate :   async   \\( postId \\)   = >   {  7             // Cancel any outgoing refetches  8             await   queryClient . cancelQueries \\( {   queryKey :   [ 'posts' ]   } \\)  9             // Snapshot for rollback 10             const   prevPosts   =   queryClient . getQueryData \\( [ 'posts' ] \\) 11             // Optimistic update \\227 toggle like immediately 12             queryClient . setQueryData \\( [ 'posts' ] ,   old   = >   old . map \\( p   = > 13                 p . id   = = =   postId 14                     ?   {   . . . p ,   liked :   ! p . liked ,   likeCount :   p . likeCount   +   \\( p . liked   ?   - 1   :   1 \\)   } 15                     :   p 16             \\) \\) 17             return   {   prevPosts   }     // pass snapshot to onError 18         } , 19         onError :   \\( err ,   postId ,   context \\)   = >   { 20             // Rollback to snapshot 21             queryClient . setQueryData \\( [ 'posts' ] ,   context . prevPosts \\) 22             toast . error \\( 'Failed to like post. Please try again.' \\) 23         } , 24         onSettled :   \\( \\)   = >   { 25             // Always sync with server when done 26             queryClient . invalidateQueries \\( {   queryKey :   [ 'posts' ]   } \\) Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 26/42."
    ],
    source: "frontend-system-design-50",
    estimatedMinutes: 4
  },
  {
    ...
    correctAnswer: "A",
    explanation: "28 } , [ connect ] ) 29 30 const send = useCallback ( ( type , payload ) = > { 31 if ( ws ? . readyState = = = WebSocket . OPEN ) 32 ws . send ( JSON . stringify ( { type , payload , timestamp : Date . now ( ) } ) ) 33 } , [ ws ] ) 34 35 return { connected , send , ws } 36 } 37 38 // Collaborative cursor presence 39 const CollabDoc = ( { docId } ) = > { 40 const { send , ws } = useWebSocket ( `wss://api/docs/${docId}` ) 41 const [ cursors , setCursors ] = useState ( { } ) // userId \\256 position 42 43 useEffect ( ( ) = > { 44 if ( ! ws ) return 45 ws . onmessage = ( e ) = > { 46 const { type , payload } = JSON . parse ( e . data ) 47 if ( type = = = 'cursor' ) setCursors ( c = > ( { . . . c , [ payload . userId ] : payload . pos } ) ) 48 if ( type = = = 'edit' ) applyEdit ( payload ) // CRDT merge 49 } 50 } , [ ws ] ) 51 52 return < DocEditor onCursorMove = { ( pos ) = > send ( 'cursor' , { pos } ) } / > 53 } n Interview Tip: Implement exponential backoff for WebSocket reconnection. Start at 1 second, double each retry, cap at 30 seconds. Without backoff, all disconnected clients reconnect simultaneously when the server restarts, creating a stampede that immediately crashes it again. Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn Frontend System Design | Comment 'FSD' for full PDF | Save \\267 Share \\267 Repost 28/42 nn FE Design",
    interviewLine: "Interview takeaway: Clearly articulate the underlying mechanism, lifecycle role, and performance trade-offs of How do you implement WebSockets for real-time collaboration? n   Answer Real-time collaboration \\(Google Docs-style\\) is the most complex frontend problem. Multiple users editing the same document simultaneously requires conflict resolution. Approaches by complexity: Polling \\227 simplest, high latency, not true real-time WebSockets \\227 low latency, bidirectional, complex server setup CRDT \\(Y.js\\) \\227 conflict-free data structures, Google Docs-level collaboration WebSocket design: Establish connection on component mount Handle reconnection with exponential backoff Message protocol \\227 JSON with type field for routing Presence \\227 who else is viewing/editing Cursor positions \\227 real-time cursor sharing Y.js for collaborative editing: Conflict-Free Replicated Data Types Offline support \\227 sync when reconnected Works with TipTap, CodeMirror, ProseMirror  1 // Custom WebSocket hook with reconnection  2 const   useWebSocket   =   \\( url \\)   = >   {  3     const   [ ws ,   setWs ]   =   useState \\( null \\)  4     const   [ connected ,   setConnected ]   =   useState \\( false \\)  5     const   reconnectDelay   =   useRef \\( 1000 \\)  6  7     const   connect   =   useCallback \\( \\( \\)   = >   {  8         const   socket   =   new   WebSocket \\( url \\)  9 10         socket . onopen   =   \\( \\)   = >   { 11             setConnected \\( true \\) 12             reconnectDelay . current   =   1000     // reset backoff 13         } 14         socket . onclose   =   \\( \\)   = >   { 15             setConnected \\( false \\) 16             // Exponential backoff reconnect 17             setTimeout \\( connect ,   reconnectDelay . current \\) 18             reconnectDelay . current   =   Math . min \\( reconnectDelay . current   *   2 ,   30000 \\) 19         } 20         socket . onerror   =   \\( err \\)   = >   console . error \\( 'WS error' ,   err \\) 21         setWs \\( socket \\) 22         return   socket 23     } ,   [ url ] \\) 24 25     useEffect \\( \\( \\)   = >   { 26         const   socket   =   connect \\( \\) 27         return   \\( \\)   = >   socket . close \\( \\) Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 28/42.",
    misconception: "Common misconception: misunderstanding the execution lifecycle, reactivity triggers, or edge cases of How do you implement WebSockets for real-time collaboration? n   Answer Real-time collaboration \\(Google Docs-style\\) is the most complex frontend problem. Multiple users editing the same document simultaneously requires conflict resolution. Approaches by complexity: Polling \\227 simplest, high latency, not true real-time WebSockets \\227 low latency, bidirectional, complex server setup CRDT \\(Y.js\\) \\227 conflict-free data structures, Google Docs-level collaboration WebSocket design: Establish connection on component mount Handle reconnection with exponential backoff Message protocol \\227 JSON with type field for routing Presence \\227 who else is viewing/editing Cursor positions \\227 real-time cursor sharing Y.js for collaborative editing: Conflict-Free Replicated Data Types Offline support \\227 sync when reconnected Works with TipTap, CodeMirror, ProseMirror  1 // Custom WebSocket hook with reconnection  2 const   useWebSocket   =   \\( url \\)   = >   {  3     const   [ ws ,   setWs ]   =   useState \\( null \\)  4     const   [ connected ,   setConnected ]   =   useState \\( false \\)  5     const   reconnectDelay   =   useRef \\( 1000 \\)  6  7     const   connect   =   useCallback \\( \\( \\)   = >   {  8         const   socket   =   new   WebSocket \\( url \\)  9 10         socket . onopen   =   \\( \\)   = >   { 11             setConnected \\( true \\) 12             reconnectDelay . current   =   1000     // reset backoff 13         } 14         socket . onclose   =   \\( \\)   = >   { 15             setConnected \\( false \\) 16             // Exponential backoff reconnect 17             setTimeout \\( connect ,   reconnectDelay . current \\) 18             reconnectDelay . current   =   Math . min \\( reconnectDelay . current   *   2 ,   30000 \\) 19         } 20         socket . onerror   =   \\( err \\)   = >   console . error \\( 'WS error' ,   err \\) 21         setWs \\( socket \\) 22         return   socket 23     } ,   [ url ] \\) 24 25     useEffect \\( \\( \\)   = >   { 26         const   socket   =   connect \\( \\) 27         return   \\( \\)   = >   socket . close \\( \\) Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 28/42.",
    hints: [
      "Consider the core principles and trade-offs of How do you implement WebSockets for real-time collaboration? n   Answer Real-time collaboration \\(Google Docs-style\\) is the most complex frontend problem. Multiple users editing the same document simultaneously requires conflict resolution. Approaches by complexity: Polling \\227 simplest, high latency, not true real-time WebSockets \\227 low latency, bidirectional, complex server setup CRDT \\(Y.js\\) \\227 conflict-free data structures, Google Docs-level collaboration WebSocket design: Establish connection on component mount Handle reconnection with exponential backoff Message protocol \\227 JSON with type field for routing Presence \\227 who else is viewing/editing Cursor positions \\227 real-time cursor sharing Y.js for collaborative editing: Conflict-Free Replicated Data Types Offline support \\227 sync when reconnected Works with TipTap, CodeMirror, ProseMirror  1 // Custom WebSocket hook with reconnection  2 const   useWebSocket   =   \\( url \\)   = >   {  3     const   [ ws ,   setWs ]   =   useState \\( null \\)  4     const   [ connected ,   setConnected ]   =   useState \\( false \\)  5     const   reconnectDelay   =   useRef \\( 1000 \\)  6  7     const   connect   =   useCallback \\( \\( \\)   = >   {  8         const   socket   =   new   WebSocket \\( url \\)  9 10         socket . onopen   =   \\( \\)   = >   { 11             setConnected \\( true \\) 12             reconnectDelay . current   =   1000     // reset backoff 13         } 14         socket . onclose   =   \\( \\)   = >   { 15             setConnected \\( false \\) 16             // Exponential backoff reconnect 17             setTimeout \\( connect ,   reconnectDelay . current \\) 18             reconnectDelay . current   =   Math . min \\( reconnectDelay . current   *   2 ,   30000 \\) 19         } 20         socket . onerror   =   \\( err \\)   = >   console . error \\( 'WS error' ,   err \\) 21         setWs \\( socket \\) 22         return   socket 23     } ,   [ url ] \\) 24 25     useEffect \\( \\( \\)   = >   { 26         const   socket   =   connect \\( \\) 27         return   \\( \\)   = >   socket . close \\( \\) Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 28/42."
    ],
    source: "frontend-system-design-50",
    estimatedMinutes: 4
  },
  {
    ...
    options: [
      {
        id: "A",
        text: "28 } 29 30 // LaunchDarkly (managed solution) 31 import { useLDClient , useFlags } from 'launchdarkly-react-client-sdk' 32 const { 'new-checkout-v2' : newCheckout } = useFlags ( ) 33 34 // Feature flag gate component 35 const Feature = ( { flag , fallback = null , children } ) = > { 36 const enabled = useFlag ( flag ) 37 return enabled ? children : fallback 38 } 39 // <Feature flag='new-dashboard' fallback={<OldDashboard />}> 40 // <NewDashboard /> 41 // </Feature> n Interview Tip: Feature flags decouple deployment from release \\227 the most powerful practice for continuous delivery.",
        isCorrect: true,
        explanation: "Correct: aligns with standard React, JavaScript, and algorithm principles."
      },
      {
    ...
    correctAnswer: "A",
    explanation: "28 } 29 30 // LaunchDarkly (managed solution) 31 import { useLDClient , useFlags } from 'launchdarkly-react-client-sdk' 32 const { 'new-checkout-v2' : newCheckout } = useFlags ( ) 33 34 // Feature flag gate component 35 const Feature = ( { flag , fallback = null , children } ) = > { 36 const enabled = useFlag ( flag ) 37 return enabled ? children : fallback 38 } 39 // <Feature flag='new-dashboard' fallback={<OldDashboard />}> 40 // <NewDashboard /> 41 // </Feature> n Interview Tip: Feature flags decouple deployment from release \\227 the most powerful practice for continuous delivery. Deploy the code with the flag off. Test in production with internal users. Gradually enable for 1%, 5%, 25%, 100% of users. If something breaks at 5%, disable the flag instantly. Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn Frontend System Design | Comment 'FSD' for full PDF | Save \\267 Share \\267 Repost 29/42 nn FE Design",
    interviewLine: "Interview takeaway: Clearly articulate the underlying mechanism, lifecycle role, and performance trade-offs of How do you implement a frontend feature flagging system? n   Answer Feature flags let you deploy code without enabling features, do gradual rollouts, and kill switches for emergencies \\227 all without redeploying. Feature flag use cases: Dark launch \\227 deploy code with flag OFF, enable gradually A/B testing \\227 50% users see variant A, 50% see variant B Beta testing \\227 enable only for internal users or beta list Kill switch \\227 instantly disable broken feature without deploy Percentage rollout \\227 enable for 5%  \\256  25%  \\256  100% of users Implementation options: Managed: LaunchDarkly, Flagsmith, Unleash \\(recommended for teams\\) DIY: API endpoint + context \\227 simple and effective Architecture: Fetch flags on app load \\(or with user session\\) Cache flags \\227 don't block render waiting for flags Fall back to default \\(off\\) if flag fetch fails Re-fetch on navigation for fresh flags  1 // DIY feature flag implementation  2 const   FeatureFlagContext   =   createContext \\( { } \\)  3  4 const   FeatureFlagProvider   =   \\( {   children   } \\)   = >   {  5     const   {   user   }   =   useAuth \\( \\)  6     const   {   data :   flags   =   { }   }   =   useQuery \\( {  7         queryKey :   [ 'flags' ,   user ? . id ] ,  8         queryFn :   \\( \\)   = >   api . getFeatureFlags \\( {   userId :   user ? . id   } \\) ,  9         staleTime :   5   *   60   *   1000 ,     // 5 min cache 10         placeholderData :   { } ,                 // don't block render 11     } \\) 12     return   \\( 13         < FeatureFlagContext . Provider   value = { flags } > 14             { children } 15         < / FeatureFlagContext . Provider > 16     \\) 17 } 18 19 const   useFlag   =   \\( flagName ,   defaultValue   =   false \\)   = >   { 20     const   flags   =   useContext \\( FeatureFlagContext \\) 21     return   flags [ flagName ]   ? ?   defaultValue 22 } 23 24 // Usage \\227 conditional render 25 const   Checkout   =   \\( \\)   = >   { 26     const   newCheckoutEnabled   =   useFlag \\( 'new-checkout-v2' \\) 27     return   newCheckoutEnabled   ?   < NewCheckout   / >   :   < OldCheckout   / > Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 29/42.",
    misconception: "Common misconception: misunderstanding the execution lifecycle, reactivity triggers, or edge cases of How do you implement a frontend feature flagging system? n   Answer Feature flags let you deploy code without enabling features, do gradual rollouts, and kill switches for emergencies \\227 all without redeploying. Feature flag use cases: Dark launch \\227 deploy code with flag OFF, enable gradually A/B testing \\227 50% users see variant A, 50% see variant B Beta testing \\227 enable only for internal users or beta list Kill switch \\227 instantly disable broken feature without deploy Percentage rollout \\227 enable for 5%  \\256  25%  \\256  100% of users Implementation options: Managed: LaunchDarkly, Flagsmith, Unleash \\(recommended for teams\\) DIY: API endpoint + context \\227 simple and effective Architecture: Fetch flags on app load \\(or with user session\\) Cache flags \\227 don't block render waiting for flags Fall back to default \\(off\\) if flag fetch fails Re-fetch on navigation for fresh flags  1 // DIY feature flag implementation  2 const   FeatureFlagContext   =   createContext \\( { } \\)  3  4 const   FeatureFlagProvider   =   \\( {   children   } \\)   = >   {  5     const   {   user   }   =   useAuth \\( \\)  6     const   {   data :   flags   =   { }   }   =   useQuery \\( {  7         queryKey :   [ 'flags' ,   user ? . id ] ,  8         queryFn :   \\( \\)   = >   api . getFeatureFlags \\( {   userId :   user ? . id   } \\) ,  9         staleTime :   5   *   60   *   1000 ,     // 5 min cache 10         placeholderData :   { } ,                 // don't block render 11     } \\) 12     return   \\( 13         < FeatureFlagContext . Provider   value = { flags } > 14             { children } 15         < / FeatureFlagContext . Provider > 16     \\) 17 } 18 19 const   useFlag   =   \\( flagName ,   defaultValue   =   false \\)   = >   { 20     const   flags   =   useContext \\( FeatureFlagContext \\) 21     return   flags [ flagName ]   ? ?   defaultValue 22 } 23 24 // Usage \\227 conditional render 25 const   Checkout   =   \\( \\)   = >   { 26     const   newCheckoutEnabled   =   useFlag \\( 'new-checkout-v2' \\) 27     return   newCheckoutEnabled   ?   < NewCheckout   / >   :   < OldCheckout   / > Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 29/42.",
    hints: [
      "Consider the core principles and trade-offs of How do you implement a frontend feature flagging system? n   Answer Feature flags let you deploy code without enabling features, do gradual rollouts, and kill switches for emergencies \\227 all without redeploying. Feature flag use cases: Dark launch \\227 deploy code with flag OFF, enable gradually A/B testing \\227 50% users see variant A, 50% see variant B Beta testing \\227 enable only for internal users or beta list Kill switch \\227 instantly disable broken feature without deploy Percentage rollout \\227 enable for 5%  \\256  25%  \\256  100% of users Implementation options: Managed: LaunchDarkly, Flagsmith, Unleash \\(recommended for teams\\) DIY: API endpoint + context \\227 simple and effective Architecture: Fetch flags on app load \\(or with user session\\) Cache flags \\227 don't block render waiting for flags Fall back to default \\(off\\) if flag fetch fails Re-fetch on navigation for fresh flags  1 // DIY feature flag implementation  2 const   FeatureFlagContext   =   createContext \\( { } \\)  3  4 const   FeatureFlagProvider   =   \\( {   children   } \\)   = >   {  5     const   {   user   }   =   useAuth \\( \\)  6     const   {   data :   flags   =   { }   }   =   useQuery \\( {  7         queryKey :   [ 'flags' ,   user ? . id ] ,  8         queryFn :   \\( \\)   = >   api . getFeatureFlags \\( {   userId :   user ? . id   } \\) ,  9         staleTime :   5   *   60   *   1000 ,     // 5 min cache 10         placeholderData :   { } ,                 // don't block render 11     } \\) 12     return   \\( 13         < FeatureFlagContext . Provider   value = { flags } > 14             { children } 15         < / FeatureFlagContext . Provider > 16     \\) 17 } 18 19 const   useFlag   =   \\( flagName ,   defaultValue   =   false \\)   = >   { 20     const   flags   =   useContext \\( FeatureFlagContext \\) 21     return   flags [ flagName ]   ? ?   defaultValue 22 } 23 24 // Usage \\227 conditional render 25 const   Checkout   =   \\( \\)   = >   { 26     const   newCheckoutEnabled   =   useFlag \\( 'new-checkout-v2' \\) 27     return   newCheckoutEnabled   ?   < NewCheckout   / >   :   < OldCheckout   / > Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 29/42."
    ],
    source: "frontend-system-design-50",
    estimatedMinutes: 4
  },
  {
    ...
    title: "What are common Frontend System Design mistakes and how to avoid them? n   Answer Understanding common mistakes shows interviewers you have production experience. Mistake 1: Putting everything in Redux Use React Query for server state. Redux only for true global client state. Mistake 2: No code splitting Single 3MB bundle = 10s load time on mobile. Split routes minimum. Mistake 3: Infinite re-renders Object/array literals as props bypass React.memo. Use useMemo/useCallback. Mistake 4: Not handling all UI states Every async operation has: loading, error, empty, success. Design all four. Mistake 5: Hardcoding dimensions Images without width/height cause CLS. Charts without ResponsiveContainer break. Mistake 6: Tokens in localStorage XSS can steal any localStorage value. Use HttpOnly cookies for auth tokens. Mistake 7: No virtualization for long lists 100K DOM nodes crash browsers. Virtualize any list over 500 items. Mistake 8: Prop drilling instead of composition Passing props 6 levels deep is a smell. Lift state or use Context/Zustand.  1 // Mistake 1: Redux for server state  2 //  n  Old way  3 dispatch \\( fetchProducts \\( \\) \\)   // action, reducer, selector \\227 so much code!  4 //  n  React Query  5 const   {   data   }   =   useQuery \\( {   queryKey :   [ 'products' ] ,   queryFn :   api . getProducts   } \\)  6  7 // Mistake 3: Object prop breaking memo  8 //  n  New object every render \\227 memo never skips  9 const   Child   =   React . memo \\( \\( {   config   } \\)   = >   < div > { config . title } < / div > \\) 10 const   Parent   =   \\( \\)   = >   < Child   config = { {   title :   'Hello'   } }   / >     // new object! 11 //  n  Either use useMemo or pass primitives 12 const   Parent   =   \\( \\)   = >   { 13     const   config   =   useMemo \\( \\( \\)   = >   \\( {   title :   'Hello'   } \\) ,   [ ] \\) 14     return   < Child   config = { config }   / > 15 } 16 17 // Mistake 7: No virtualization 18 //  n  100K DOM nodes 19 const   BadList   =   \\( {   items   } \\)   = >   items . map \\( i   = >   < Row   key = { i . id }   { . . . i }   / > \\) 20 //  n  Virtual list \\227 only renders ~20 items 21 const   GoodList   =   \\( {   items   } \\)   = >   \\( 22     < VirtualList   items = { items }   renderItem = { \\( item \\)   = >   < Row   { . . . item }   / > }   / > Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 40/42",
    prompt: "What are common Frontend System Design mistakes and how to avoid them? n   Answer Understanding common mistakes shows interviewers you have production experience. Mistake 1: Putting everything in Redux Use React Query for server state. Redux only for true global client state. Mistake 2: No code splitting Single 3MB bundle = 10s load time on mobile. Split routes minimum. Mistake 3: Infinite re-renders Object/array literals as props bypass React.memo. Use useMemo/useCallback. Mistake 4: Not handling all UI states Every async operation has: loading, error, empty, success. Design all four. Mistake 5: Hardcoding dimensions Images without width/height cause CLS. Charts without ResponsiveContainer break. Mistake 6: Tokens in localStorage XSS can steal any localStorage value. Use HttpOnly cookies for auth tokens. Mistake 7: No virtualization for long lists 100K DOM nodes crash browsers. Virtualize any list over 500 items. Mistake 8: Prop drilling instead of composition Passing props 6 levels deep is a smell. Lift state or use Context/Zustand.  1 // Mistake 1: Redux for server state  2 //  n  Old way  3 dispatch \\( fetchProducts \\( \\) \\)   // action, reducer, selector \\227 so much code!  4 //  n  React Query  5 const   {   data   }   =   useQuery \\( {   queryKey :   [ 'products' ] ,   queryFn :   api . getProducts   } \\)  6  7 // Mistake 3: Object prop breaking memo  8 //  n  New object every render \\227 memo never skips  9 const   Child   =   React . memo \\( \\( {   config   } \\)   = >   < div > { config . title } < / div > \\) 10 const   Parent   =   \\( \\)   = >   < Child   config = { {   title :   'Hello'   } }   / >     // new object! 11 //  n  Either use useMemo or pass primitives 12 const   Parent   =   \\( \\)   = >   { 13     const   config   =   useMemo \\( \\( \\)   = >   \\( {   title :   'Hello'   } \\) ,   [ ] \\) 14     return   < Child   config = { config }   / > 15 } 16 17 // Mistake 7: No virtualization 18 //  n  100K DOM nodes 19 const   BadList   =   \\( {   items   } \\)   = >   items . map \\( i   = >   < Row   key = { i . id }   { . . . i }   / > \\) 20 //  n  Virtual list \\227 only renders ~20 items 21 const   GoodList   =   \\( {   items   } \\)   = >   \\( 22     < VirtualList   items = { items }   renderItem = { \\( item \\)   = >   < Row   { . . . item }   / > }   / > Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 40/42",
    level: "senior",
    type: "live_code",
    category: "system_design",
    subject: "hooks",
    ...
    correctAnswer: "A",
    explanation: "23 ) 24 25 // Mistake 5: CLS from missing image dimensions 26 // n Layout shifts as image loads 27 // <img src='/product.jpg' /> 28 // n Reserve space 29 // <img src='/product.jpg' width={400} height={300} /> 30 // or: aspect-ratio: 4/3 in CSS n Interview Tip: The interview will test if you have scars from production mistakes. Talk about times you hit these problems, how you diagnosed them (React Profiler, Lighthouse, DevTools), and how you fixed them. Candidates who say 'I learned this from production' are more credible than those who only know theory. Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn Frontend System Design | Comment 'FSD' for full PDF | Save \\267 Share \\267 Repost 40/42 nn FE Design",
    interviewLine: "Interview takeaway: Clearly articulate the underlying mechanism, lifecycle role, and performance trade-offs of What are common Frontend System Design mistakes and how to avoid them? n   Answer Understanding common mistakes shows interviewers you have production experience. Mistake 1: Putting everything in Redux Use React Query for server state. Redux only for true global client state. Mistake 2: No code splitting Single 3MB bundle = 10s load time on mobile. Split routes minimum. Mistake 3: Infinite re-renders Object/array literals as props bypass React.memo. Use useMemo/useCallback. Mistake 4: Not handling all UI states Every async operation has: loading, error, empty, success. Design all four. Mistake 5: Hardcoding dimensions Images without width/height cause CLS. Charts without ResponsiveContainer break. Mistake 6: Tokens in localStorage XSS can steal any localStorage value. Use HttpOnly cookies for auth tokens. Mistake 7: No virtualization for long lists 100K DOM nodes crash browsers. Virtualize any list over 500 items. Mistake 8: Prop drilling instead of composition Passing props 6 levels deep is a smell. Lift state or use Context/Zustand.  1 // Mistake 1: Redux for server state  2 //  n  Old way  3 dispatch \\( fetchProducts \\( \\) \\)   // action, reducer, selector \\227 so much code!  4 //  n  React Query  5 const   {   data   }   =   useQuery \\( {   queryKey :   [ 'products' ] ,   queryFn :   api . getProducts   } \\)  6  7 // Mistake 3: Object prop breaking memo  8 //  n  New object every render \\227 memo never skips  9 const   Child   =   React . memo \\( \\( {   config   } \\)   = >   < div > { config . title } < / div > \\) 10 const   Parent   =   \\( \\)   = >   < Child   config = { {   title :   'Hello'   } }   / >     // new object! 11 //  n  Either use useMemo or pass primitives 12 const   Parent   =   \\( \\)   = >   { 13     const   config   =   useMemo \\( \\( \\)   = >   \\( {   title :   'Hello'   } \\) ,   [ ] \\) 14     return   < Child   config = { config }   / > 15 } 16 17 // Mistake 7: No virtualization 18 //  n  100K DOM nodes 19 const   BadList   =   \\( {   items   } \\)   = >   items . map \\( i   = >   < Row   key = { i . id }   { . . . i }   / > \\) 20 //  n  Virtual list \\227 only renders ~20 items 21 const   GoodList   =   \\( {   items   } \\)   = >   \\( 22     < VirtualList   items = { items }   renderItem = { \\( item \\)   = >   < Row   { . . . item }   / > }   / > Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 40/42.",
    misconception: "Common misconception: misunderstanding the execution lifecycle, reactivity triggers, or edge cases of What are common Frontend System Design mistakes and how to avoid them? n   Answer Understanding common mistakes shows interviewers you have production experience. Mistake 1: Putting everything in Redux Use React Query for server state. Redux only for true global client state. Mistake 2: No code splitting Single 3MB bundle = 10s load time on mobile. Split routes minimum. Mistake 3: Infinite re-renders Object/array literals as props bypass React.memo. Use useMemo/useCallback. Mistake 4: Not handling all UI states Every async operation has: loading, error, empty, success. Design all four. Mistake 5: Hardcoding dimensions Images without width/height cause CLS. Charts without ResponsiveContainer break. Mistake 6: Tokens in localStorage XSS can steal any localStorage value. Use HttpOnly cookies for auth tokens. Mistake 7: No virtualization for long lists 100K DOM nodes crash browsers. Virtualize any list over 500 items. Mistake 8: Prop drilling instead of composition Passing props 6 levels deep is a smell. Lift state or use Context/Zustand.  1 // Mistake 1: Redux for server state  2 //  n  Old way  3 dispatch \\( fetchProducts \\( \\) \\)   // action, reducer, selector \\227 so much code!  4 //  n  React Query  5 const   {   data   }   =   useQuery \\( {   queryKey :   [ 'products' ] ,   queryFn :   api . getProducts   } \\)  6  7 // Mistake 3: Object prop breaking memo  8 //  n  New object every render \\227 memo never skips  9 const   Child   =   React . memo \\( \\( {   config   } \\)   = >   < div > { config . title } < / div > \\) 10 const   Parent   =   \\( \\)   = >   < Child   config = { {   title :   'Hello'   } }   / >     // new object! 11 //  n  Either use useMemo or pass primitives 12 const   Parent   =   \\( \\)   = >   { 13     const   config   =   useMemo \\( \\( \\)   = >   \\( {   title :   'Hello'   } \\) ,   [ ] \\) 14     return   < Child   config = { config }   / > 15 } 16 17 // Mistake 7: No virtualization 18 //  n  100K DOM nodes 19 const   BadList   =   \\( {   items   } \\)   = >   items . map \\( i   = >   < Row   key = { i . id }   { . . . i }   / > \\) 20 //  n  Virtual list \\227 only renders ~20 items 21 const   GoodList   =   \\( {   items   } \\)   = >   \\( 22     < VirtualList   items = { items }   renderItem = { \\( item \\)   = >   < Row   { . . . item }   / > }   / > Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 40/42.",
    hints: [
      "Consider the core principles and trade-offs of What are common Frontend System Design mistakes and how to avoid them? n   Answer Understanding common mistakes shows interviewers you have production experience. Mistake 1: Putting everything in Redux Use React Query for server state. Redux only for true global client state. Mistake 2: No code splitting Single 3MB bundle = 10s load time on mobile. Split routes minimum. Mistake 3: Infinite re-renders Object/array literals as props bypass React.memo. Use useMemo/useCallback. Mistake 4: Not handling all UI states Every async operation has: loading, error, empty, success. Design all four. Mistake 5: Hardcoding dimensions Images without width/height cause CLS. Charts without ResponsiveContainer break. Mistake 6: Tokens in localStorage XSS can steal any localStorage value. Use HttpOnly cookies for auth tokens. Mistake 7: No virtualization for long lists 100K DOM nodes crash browsers. Virtualize any list over 500 items. Mistake 8: Prop drilling instead of composition Passing props 6 levels deep is a smell. Lift state or use Context/Zustand.  1 // Mistake 1: Redux for server state  2 //  n  Old way  3 dispatch \\( fetchProducts \\( \\) \\)   // action, reducer, selector \\227 so much code!  4 //  n  React Query  5 const   {   data   }   =   useQuery \\( {   queryKey :   [ 'products' ] ,   queryFn :   api . getProducts   } \\)  6  7 // Mistake 3: Object prop breaking memo  8 //  n  New object every render \\227 memo never skips  9 const   Child   =   React . memo \\( \\( {   config   } \\)   = >   < div > { config . title } < / div > \\) 10 const   Parent   =   \\( \\)   = >   < Child   config = { {   title :   'Hello'   } }   / >     // new object! 11 //  n  Either use useMemo or pass primitives 12 const   Parent   =   \\( \\)   = >   { 13     const   config   =   useMemo \\( \\( \\)   = >   \\( {   title :   'Hello'   } \\) ,   [ ] \\) 14     return   < Child   config = { config }   / > 15 } 16 17 // Mistake 7: No virtualization 18 //  n  100K DOM nodes 19 const   BadList   =   \\( {   items   } \\)   = >   items . map \\( i   = >   < Row   key = { i . id }   { . . . i }   / > \\) 20 //  n  Virtual list \\227 only renders ~20 items 21 const   GoodList   =   \\( {   items   } \\)   = >   \\( 22     < VirtualList   items = { items }   renderItem = { \\( item \\)   = >   < Row   { . . . item }   / > }   / > Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 40/42."
    ],
    source: "frontend-system-design-50",
    estimatedMinutes: 4
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of Rotate array right by k \\(in."
    ],
  ...
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of Merge overlapping intervals."
    ],
    source: "dsa-interview",
    estimatedMinutes: 3
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of Majority Element \\(Boyer."
    ],
    source: "dsa-interview",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of Longest Common Prefix."
    ],
    source: "dsa-interview",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of Longest."
    ],
    source: "dsa-interview",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of Two Sum."
    ],
    source: "dsa-interview",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of Subarray Sum Equals K \\(count\\."
    ],
    source: "dsa-interview",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of Longest Substring Without Repeating Characters."
    ],
    source: "dsa-interview",
    estimatedMinutes: 3
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of Minimum Window Substrin."
    ],
    source: "dsa-interview",
    estimatedMinutes: 3
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of Longest Subarray with At Most K Distinct."
    ],
    source: "dsa-interview",
    estimatedMinutes: 3
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of Shortest Path in Unweighted Graph \\(BFS returning path\\."
    ],
    source: "dsa-interview",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of Detect Cycle in Directed Graph \\(."
    ],
    source: "dsa-interview",
    estimatedMinutes: 4
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of Number of Connected Components \\(Union."
    ],
    source: "dsa-interview",
    estimatedMinutes: 2
  }
