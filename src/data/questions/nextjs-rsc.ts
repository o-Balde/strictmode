...
export const NEXTJS_RSC_QUESTIONS: QuizQuestion[] = [
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of What is SSR (Server-Side Rendering)?."
    ],
    source: "44-react",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of What are the main functions of Next.js that you know?."
    ],
    source: "44-react",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of React Server Components (RSC) run only on the server and are never sent to the client as JavaScript. They practically help in reducing bundle size and improving performance.."
    ],
  ...
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of What are React Suspense and React.lazy? How do they enable code splitting?."
    ],
    source: "interviewbit-70",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of When should you use a class component over a function component?."
    ],
    source: "100-react",
    estimatedMinutes: 3
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of What is the TestRenderer package in React?."
    ],
    source: "100-react",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of What's new in React 19?."
    ],
    source: "100-react",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of What are React Server Components?."
    ],
    source: "100-react",
    estimatedMinutes: 2
  },
  {
    ...
    hints: [
      "Consider the core principles and trade-offs of What's the difference between Server Components and Client Components?."
    ],
    source: "100-react",
    estimatedMinutes: 2
  },
  {
    ...
    correctAnswer: "A",
    explanation: "Next.js is a popular and lightweight framework for static and server\ufffd\ufffd\ufffdrendered applications built with React. It also provides styling and routing solutions. Below are the major features provided by NextJS, Server-rendered by default Automatic code splitting for faster page loads Simple client-side routing (page based) Webpack-based dev environment which supports (HMR) Able to implement with Express or any other Node.js HTTP server Customizable with your own Babel and Webpack configurations \ufffd\ufffd\ufffd Back to Top",
    ...
    hints: [
      "Consider the core principles and trade-offs of What is NextJS and major features of it?."
    ],
    source: "300-react",
    estimatedMinutes: 2
  },
  {
    ...
    title: "How do you design a virtualized list for rendering 100,000 rows? n   Answer Virtualisation renders only visible items in the DOM \\227 not all 100,000. This keeps memory low and scrolling smooth regardless of list size. Why naively rendering 100K items fails: 100K DOM nodes = 2-3GB memory usage Scroll jank \\227 browser can't paint 100K nodes at 60fps Initial render: 5-10 seconds How virtualization works: Calculate which items are visible in the viewport Render only those items \\(20-50 items typically\\) Create top/bottom padding spacers for scroll position As user scrolls, swap out items in and out of DOM Libraries: TanStack Virtual \\227 most modern, headless react-window \\227 lightweight, production-ready react-virtuoso \\227 variable height, complex use cases When to use: Lists > 500 items \\227 always virtualize Infinite scroll feeds \\(Twitter, Instagram\\) Data tables with thousands of rows  1 import   {   useVirtualizer   }   from   '@tanstack/react-virtual'  2  3 const   VirtualList   =   \\( {   items   } \\)   = >   {  4     const   parentRef   =   useRef \\( null \\)  5  6     const   virtualizer   =   useVirtualizer \\( {  7         count :   items . length ,                   // total item count \\(100,000!\\)  8         getScrollElement :   \\( \\)   = >   parentRef . current ,  9         estimateSize :   \\( \\)   = >   72 ,             // estimated row height in px 10         overscan :   5 ,                                   // render 5 extra above/below viewport 11     } \\) 12 13     return   \\( 14         // Scroll container 15         < div   ref = { parentRef }   style = { {   height :   '600px' ,   overflow :   'auto'   } } > 16             { / *   Total   height   spacer   \\227   makes   scrollbar   accurate   * / } 17             < div   style = { {   height :   virtualizer . getTotalSize \\( \\) ,   position :   'relative'   } } > 18                 { virtualizer . getVirtualItems \\( \\) . map \\( virtualRow   = >   \\( 19                     < div 20                         key = { virtualRow . key } 21                         style = { { 22                             position :   'absolute' , 23                             top :   virtualRow . start ,       // pixel offset from top Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 7/42",
    prompt: "How do you design a virtualized list for rendering 100,000 rows? n   Answer Virtualisation renders only visible items in the DOM \\227 not all 100,000. This keeps memory low and scrolling smooth regardless of list size. Why naively rendering 100K items fails: 100K DOM nodes = 2-3GB memory usage Scroll jank \\227 browser can't paint 100K nodes at 60fps Initial render: 5-10 seconds How virtualization works: Calculate which items are visible in the viewport Render only those items \\(20-50 items typically\\) Create top/bottom padding spacers for scroll position As user scrolls, swap out items in and out of DOM Libraries: TanStack Virtual \\227 most modern, headless react-window \\227 lightweight, production-ready react-virtuoso \\227 variable height, complex use cases When to use: Lists > 500 items \\227 always virtualize Infinite scroll feeds \\(Twitter, Instagram\\) Data tables with thousands of rows  1 import   {   useVirtualizer   }   from   '@tanstack/react-virtual'  2  3 const   VirtualList   =   \\( {   items   } \\)   = >   {  4     const   parentRef   =   useRef \\( null \\)  5  6     const   virtualizer   =   useVirtualizer \\( {  7         count :   items . length ,                   // total item count \\(100,000!\\)  8         getScrollElement :   \\( \\)   = >   parentRef . current ,  9         estimateSize :   \\( \\)   = >   72 ,             // estimated row height in px 10         overscan :   5 ,                                   // render 5 extra above/below viewport 11     } \\) 12 13     return   \\( 14         // Scroll container 15         < div   ref = { parentRef }   style = { {   height :   '600px' ,   overflow :   'auto'   } } > 16             { / *   Total   height   spacer   \\227   makes   scrollbar   accurate   * / } 17             < div   style = { {   height :   virtualizer . getTotalSize \\( \\) ,   position :   'relative'   } } > 18                 { virtualizer . getVirtualItems \\( \\) . map \\( virtualRow   = >   \\( 19                     < div 20                         key = { virtualRow . key } 21                         style = { { 22                             position :   'absolute' , 23                             top :   virtualRow . start ,       // pixel offset from top Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 7/42",
    level: "senior",
    type: "concept",
    category: "nextjs",
    ...
    correctAnswer: "A",
    explanation: "24 width : '100%' , 25 height : virtualRow . size , // row height 26 } } 27 > 28 { / * Only renders ~ 20 - 50 items at any time * / } 29 < ProductRow product = { items [ virtualRow . index ] } / > 30 < / div > 31 ) ) } 32 < / div > 33 < / div > 34 ) 35 } 36 37 // Combine with infinite scroll 38 const { data , fetchNextPage , hasNextPage } = useInfiniteQuery ( { 39 queryKey : [ 'products' ] , 40 queryFn : ( { pageParam } ) = > api . getProducts ( { cursor : pageParam } ) , 41 getNextPageParam : ( lastPage ) = > lastPage . nextCursor 42 } ) n Interview Tip: Virtual + infinite scroll is the standard pattern for social feeds. Virtual renders only visible items (memory-safe), infinite scroll fetches next page when user approaches the bottom (no upfront data cost). Both Twitter and Instagram use this exact combination. Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn Frontend System Design | Comment 'FSD' for full PDF | Save \\267 Share \\267 Repost 7/42 nn FE Design",
  ...
  },
  {
    ...
    title: "What are Core Web Vitals and how do you improve them? n   Answer Core Web Vitals are Google's standardised performance metrics that directly affect SEO rankings. The 3 Core Web Vitals \\(2024\\): LCP \\227 Largest Contentful Paint: time to render largest element Good: < 2.5s Needs work: < 4s Poor: > 4s INP \\227 Interaction to Next Paint: responsiveness to user input Good: < 200ms Needs work: < 500ms Poor: > 500ms CLS \\227 Cumulative Layout Shift: visual stability \\(no jumps\\) Good: < 0.1 Needs work: < 0.25 Poor: > 0.25 How to improve LCP: Preload hero image with <link rel=preload> Use next/image or optimised formats \\(WebP/AVIF\\) Eliminate render-blocking scripts Use CDN for static assets How to improve INP: Break long tasks with setTimeout or scheduler.yield\\(\\) Use Web Workers for heavy computation Reduce JavaScript execution time How to improve CLS: Always set width/height on images Reserve space for ads and embeds Avoid inserting DOM above existing content  1 // LCP: preload hero image \\(biggest win for LCP\\)  2 < link   rel = 'preload'   as = 'image'   href = '/hero.webp'   / >  3  4 // CLS: always set dimensions on images  5 < img   src = '/product.webp'   width = { 800 }   height = { 600 }   alt = 'Product'   / >  6 // Or use aspect-ratio CSS to reserve space  7 // .img-container { aspect-ratio: 4/3; }  8  9 // INP: break up long tasks with yield 10 async   function   processLargeDataset \\( items \\)   { 11     const   CHUNK   =   50 12     for   \\( let   i   =   0 ;   i   <   items . length ;   i   + =   CHUNK \\)   { 13         const   chunk   =   items . slice \\( i ,   i   +   CHUNK \\) 14         processChunk \\( chunk \\) 15         // Yield to browser every 50 items 16         await   new   Promise \\( r   = >   setTimeout \\( r ,   0 \\) \\) 17     } 18 } 19 20 // Measure CWV in code Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 12/42",
    ...
    correctAnswer: "A",
    explanation: "21 import { onLCP , onINP , onCLS } from 'web-vitals' 22 onLCP ( metric = > analytics . track ( 'LCP' , { value : metric . value } ) ) 23 onINP ( metric = > analytics . track ( 'INP' , { value : metric . value } ) ) 24 onCLS ( metric = > analytics . track ( 'CLS' , { value : metric . value } ) ) 25 26 // Next.js: built-in CWV reporting 27 export function reportWebVitals ( metric ) { 28 if ( metric . label = = = 'web-vital' ) { 29 analytics . send ( { name : metric . name , value : metric . value } ) 30 } 31 } n Interview Tip: LCP is the most impactful CWV to fix. The LCP killer is the hero image not being preloaded. Add <link rel=preload as=image> for your LCP element and you can often improve LCP by 500ms-1s instantly. Measure before and after with Lighthouse or web.dev/measure. Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn Frontend System Design | Comment 'FSD' for full PDF | Save \\267 Share \\267 Repost 12/42 nn FE Design",
    interviewLine: "Interview takeaway: Clearly articulate the underlying mechanism, lifecycle role, and performance trade-offs of What are Core Web Vitals and how do you improve them? n   Answer Core Web Vitals are Google's standardised performance metrics that directly affect SEO rankings. The 3 Core Web Vitals \\(2024\\): LCP \\227 Largest Contentful Paint: time to render largest element Good: < 2.5s Needs work: < 4s Poor: > 4s INP \\227 Interaction to Next Paint: responsiveness to user input Good: < 200ms Needs work: < 500ms Poor: > 500ms CLS \\227 Cumulative Layout Shift: visual stability \\(no jumps\\) Good: < 0.1 Needs work: < 0.25 Poor: > 0.25 How to improve LCP: Preload hero image with <link rel=preload> Use next/image or optimised formats \\(WebP/AVIF\\) Eliminate render-blocking scripts Use CDN for static assets How to improve INP: Break long tasks with setTimeout or scheduler.yield\\(\\) Use Web Workers for heavy computation Reduce JavaScript execution time How to improve CLS: Always set width/height on images Reserve space for ads and embeds Avoid inserting DOM above existing content  1 // LCP: preload hero image \\(biggest win for LCP\\)  2 < link   rel = 'preload'   as = 'image'   href = '/hero.webp'   / >  3  4 // CLS: always set dimensions on images  5 < img   src = '/product.webp'   width = { 800 }   height = { 600 }   alt = 'Product'   / >  6 // Or use aspect-ratio CSS to reserve space  7 // .img-container { aspect-ratio: 4/3; }  8  9 // INP: break up long tasks with yield 10 async   function   processLargeDataset \\( items \\)   { 11     const   CHUNK   =   50 12     for   \\( let   i   =   0 ;   i   <   items . length ;   i   + =   CHUNK \\)   { 13         const   chunk   =   items . slice \\( i ,   i   +   CHUNK \\) 14         processChunk \\( chunk \\) 15         // Yield to browser every 50 items 16         await   new   Promise \\( r   = >   setTimeout \\( r ,   0 \\) \\) 17     } 18 } 19 20 // Measure CWV in code Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 12/42.",
    misconception: "Common misconception: misunderstanding the execution lifecycle, reactivity triggers, or edge cases of What are Core Web Vitals and how do you improve them? n   Answer Core Web Vitals are Google's standardised performance metrics that directly affect SEO rankings. The 3 Core Web Vitals \\(2024\\): LCP \\227 Largest Contentful Paint: time to render largest element Good: < 2.5s Needs work: < 4s Poor: > 4s INP \\227 Interaction to Next Paint: responsiveness to user input Good: < 200ms Needs work: < 500ms Poor: > 500ms CLS \\227 Cumulative Layout Shift: visual stability \\(no jumps\\) Good: < 0.1 Needs work: < 0.25 Poor: > 0.25 How to improve LCP: Preload hero image with <link rel=preload> Use next/image or optimised formats \\(WebP/AVIF\\) Eliminate render-blocking scripts Use CDN for static assets How to improve INP: Break long tasks with setTimeout or scheduler.yield\\(\\) Use Web Workers for heavy computation Reduce JavaScript execution time How to improve CLS: Always set width/height on images Reserve space for ads and embeds Avoid inserting DOM above existing content  1 // LCP: preload hero image \\(biggest win for LCP\\)  2 < link   rel = 'preload'   as = 'image'   href = '/hero.webp'   / >  3  4 // CLS: always set dimensions on images  5 < img   src = '/product.webp'   width = { 800 }   height = { 600 }   alt = 'Product'   / >  6 // Or use aspect-ratio CSS to reserve space  7 // .img-container { aspect-ratio: 4/3; }  8  9 // INP: break up long tasks with yield 10 async   function   processLargeDataset \\( items \\)   { 11     const   CHUNK   =   50 12     for   \\( let   i   =   0 ;   i   <   items . length ;   i   + =   CHUNK \\)   { 13         const   chunk   =   items . slice \\( i ,   i   +   CHUNK \\) 14         processChunk \\( chunk \\) 15         // Yield to browser every 50 items 16         await   new   Promise \\( r   = >   setTimeout \\( r ,   0 \\) \\) 17     } 18 } 19 20 // Measure CWV in code Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 12/42.",
    hints: [
      "Consider the core principles and trade-offs of What are Core Web Vitals and how do you improve them? n   Answer Core Web Vitals are Google's standardised performance metrics that directly affect SEO rankings. The 3 Core Web Vitals \\(2024\\): LCP \\227 Largest Contentful Paint: time to render largest element Good: < 2.5s Needs work: < 4s Poor: > 4s INP \\227 Interaction to Next Paint: responsiveness to user input Good: < 200ms Needs work: < 500ms Poor: > 500ms CLS \\227 Cumulative Layout Shift: visual stability \\(no jumps\\) Good: < 0.1 Needs work: < 0.25 Poor: > 0.25 How to improve LCP: Preload hero image with <link rel=preload> Use next/image or optimised formats \\(WebP/AVIF\\) Eliminate render-blocking scripts Use CDN for static assets How to improve INP: Break long tasks with setTimeout or scheduler.yield\\(\\) Use Web Workers for heavy computation Reduce JavaScript execution time How to improve CLS: Always set width/height on images Reserve space for ads and embeds Avoid inserting DOM above existing content  1 // LCP: preload hero image \\(biggest win for LCP\\)  2 < link   rel = 'preload'   as = 'image'   href = '/hero.webp'   / >  3  4 // CLS: always set dimensions on images  5 < img   src = '/product.webp'   width = { 800 }   height = { 600 }   alt = 'Product'   / >  6 // Or use aspect-ratio CSS to reserve space  7 // .img-container { aspect-ratio: 4/3; }  8  9 // INP: break up long tasks with yield 10 async   function   processLargeDataset \\( items \\)   { 11     const   CHUNK   =   50 12     for   \\( let   i   =   0 ;   i   <   items . length ;   i   + =   CHUNK \\)   { 13         const   chunk   =   items . slice \\( i ,   i   +   CHUNK \\) 14         processChunk \\( chunk \\) 15         // Yield to browser every 50 items 16         await   new   Promise \\( r   = >   setTimeout \\( r ,   0 \\) \\) 17     } 18 } 19 20 // Measure CWV in code Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 12/42."
    ],
    source: "frontend-system-design-50",
    estimatedMinutes: 4
  },
  {
    ...
    title: "What is the difference between CSR, SSR, SSG, and ISR? n   Answer Rendering strategy determines when and where HTML is generated. Each has different performance, SEO, and infrastructure implications. CSR \\227 Client-Side Rendering: Server sends empty HTML + JS bundle Browser downloads JS, executes, renders UI Good for: dashboards, admin panels, apps behind auth Bad for: SEO \\(empty HTML\\), slow FCP SSR \\227 Server-Side Rendering: Server renders full HTML on each request User sees content immediately \\(fast FCP\\) Good for: dynamic pages with user-specific data, SEO Bad for: server load, TTFB can be high SSG \\227 Static Site Generation: HTML generated at build time Served from CDN \\227 fastest possible Good for: blogs, marketing pages, documentation Bad for: dynamic user-specific content ISR \\227 Incremental Static Regeneration \\(Next.js\\): SSG pages regenerated in background after stale Best of SSG \\(speed\\) + SSR \\(freshness\\) Good for: product pages, news articles  1 // CSR: useEffect fetches after browser render  2 const   Dashboard   =   \\( \\)   = >   {  3     const   {   data   }   =   useQuery \\( {   queryKey :   [ 'dashboard' ] ,   queryFn :   api . getDashboard   } \\)  4     return   < DashboardView   data = { data }   / >  5 }  6  7 // SSR: Next.js App Router \\227 Server Component  8 // app/products/page.tsx  9 async   function   ProductsPage \\( \\)   { 10     // Runs on server \\227 no useEffect, no loading state 11     const   products   =   await   db . product . findMany \\( {   where :   {   active :   true   }   } \\) 12     return   < ProductList   products = { products }   / > 13 } 14 15 // SSG: Next.js static generation \\(generated at build\\) 16 // app/blog/[slug]/page.tsx 17 export   async   function   generateStaticParams \\( \\)   { 18     const   posts   =   await   api . getAllPosts \\( \\) 19     return   posts . map \\( post   = >   \\( {   slug :   post . slug   } \\) \\) 20 } Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 22/42",
    prompt: "What is the difference between CSR, SSR, SSG, and ISR? n   Answer Rendering strategy determines when and where HTML is generated. Each has different performance, SEO, and infrastructure implications. CSR \\227 Client-Side Rendering: Server sends empty HTML + JS bundle Browser downloads JS, executes, renders UI Good for: dashboards, admin panels, apps behind auth Bad for: SEO \\(empty HTML\\), slow FCP SSR \\227 Server-Side Rendering: Server renders full HTML on each request User sees content immediately \\(fast FCP\\) Good for: dynamic pages with user-specific data, SEO Bad for: server load, TTFB can be high SSG \\227 Static Site Generation: HTML generated at build time Served from CDN \\227 fastest possible Good for: blogs, marketing pages, documentation Bad for: dynamic user-specific content ISR \\227 Incremental Static Regeneration \\(Next.js\\): SSG pages regenerated in background after stale Best of SSG \\(speed\\) + SSR \\(freshness\\) Good for: product pages, news articles  1 // CSR: useEffect fetches after browser render  2 const   Dashboard   =   \\( \\)   = >   {  3     const   {   data   }   =   useQuery \\( {   queryKey :   [ 'dashboard' ] ,   queryFn :   api . getDashboard   } \\)  4     return   < DashboardView   data = { data }   / >  5 }  6  7 // SSR: Next.js App Router \\227 Server Component  8 // app/products/page.tsx  9 async   function   ProductsPage \\( \\)   { 10     // Runs on server \\227 no useEffect, no loading state 11     const   products   =   await   db . product . findMany \\( {   where :   {   active :   true   }   } \\) 12     return   < ProductList   products = { products }   / > 13 } 14 15 // SSG: Next.js static generation \\(generated at build\\) 16 // app/blog/[slug]/page.tsx 17 export   async   function   generateStaticParams \\( \\)   { 18     const   posts   =   await   api . getAllPosts \\( \\) 19     return   posts . map \\( post   = >   \\( {   slug :   post . slug   } \\) \\) 20 } Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 22/42",
    level: "senior",
    type: "concept",
    category: "nextjs",
    subject: "hooks",
    ...
    correctAnswer: "A",
    explanation: "21 async function BlogPost ( { params } ) { 22 const post = await api . getPost ( params . slug ) // fetched at build time 23 return < Article post = { post } / > 24 } 25 26 // ISR: revalidate every 60 seconds 27 async function ProductPage ( { params } ) { 28 const product = await api . getProduct ( params . id ) 29 return < ProductView product = { product } / > 30 } 31 export const revalidate = 60 // regenerate every 60 seconds 32 33 // Decision table: 34 // SEO needed + dynamic data \\256 SSR 35 // SEO needed + static data \\256 SSG or ISR 36 // No SEO (auth required) \\256 CSR 37 // High traffic + SEO \\256 ISR (CDN-cached SSR) n Interview Tip: The modern pattern: use React Server Components (Next.js App Router) by default. Server Components fetch data on the server at request time without shipping JavaScript to the client. Switch to Client Components only for interactivity (useState, useEffect, event handlers). Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn Frontend System Design | Comment 'FSD' for full PDF | Save \\267 Share \\267 Repost 22/42 nn FE Design",
    interviewLine: "Interview takeaway: Clearly articulate the underlying mechanism, lifecycle role, and performance trade-offs of What is the difference between CSR, SSR, SSG, and ISR? n   Answer Rendering strategy determines when and where HTML is generated. Each has different performance, SEO, and infrastructure implications. CSR \\227 Client-Side Rendering: Server sends empty HTML + JS bundle Browser downloads JS, executes, renders UI Good for: dashboards, admin panels, apps behind auth Bad for: SEO \\(empty HTML\\), slow FCP SSR \\227 Server-Side Rendering: Server renders full HTML on each request User sees content immediately \\(fast FCP\\) Good for: dynamic pages with user-specific data, SEO Bad for: server load, TTFB can be high SSG \\227 Static Site Generation: HTML generated at build time Served from CDN \\227 fastest possible Good for: blogs, marketing pages, documentation Bad for: dynamic user-specific content ISR \\227 Incremental Static Regeneration \\(Next.js\\): SSG pages regenerated in background after stale Best of SSG \\(speed\\) + SSR \\(freshness\\) Good for: product pages, news articles  1 // CSR: useEffect fetches after browser render  2 const   Dashboard   =   \\( \\)   = >   {  3     const   {   data   }   =   useQuery \\( {   queryKey :   [ 'dashboard' ] ,   queryFn :   api . getDashboard   } \\)  4     return   < DashboardView   data = { data }   / >  5 }  6  7 // SSR: Next.js App Router \\227 Server Component  8 // app/products/page.tsx  9 async   function   ProductsPage \\( \\)   { 10     // Runs on server \\227 no useEffect, no loading state 11     const   products   =   await   db . product . findMany \\( {   where :   {   active :   true   }   } \\) 12     return   < ProductList   products = { products }   / > 13 } 14 15 // SSG: Next.js static generation \\(generated at build\\) 16 // app/blog/[slug]/page.tsx 17 export   async   function   generateStaticParams \\( \\)   { 18     const   posts   =   await   api . getAllPosts \\( \\) 19     return   posts . map \\( post   = >   \\( {   slug :   post . slug   } \\) \\) 20 } Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 22/42.",
    misconception: "Common misconception: misunderstanding the execution lifecycle, reactivity triggers, or edge cases of What is the difference between CSR, SSR, SSG, and ISR? n   Answer Rendering strategy determines when and where HTML is generated. Each has different performance, SEO, and infrastructure implications. CSR \\227 Client-Side Rendering: Server sends empty HTML + JS bundle Browser downloads JS, executes, renders UI Good for: dashboards, admin panels, apps behind auth Bad for: SEO \\(empty HTML\\), slow FCP SSR \\227 Server-Side Rendering: Server renders full HTML on each request User sees content immediately \\(fast FCP\\) Good for: dynamic pages with user-specific data, SEO Bad for: server load, TTFB can be high SSG \\227 Static Site Generation: HTML generated at build time Served from CDN \\227 fastest possible Good for: blogs, marketing pages, documentation Bad for: dynamic user-specific content ISR \\227 Incremental Static Regeneration \\(Next.js\\): SSG pages regenerated in background after stale Best of SSG \\(speed\\) + SSR \\(freshness\\) Good for: product pages, news articles  1 // CSR: useEffect fetches after browser render  2 const   Dashboard   =   \\( \\)   = >   {  3     const   {   data   }   =   useQuery \\( {   queryKey :   [ 'dashboard' ] ,   queryFn :   api . getDashboard   } \\)  4     return   < DashboardView   data = { data }   / >  5 }  6  7 // SSR: Next.js App Router \\227 Server Component  8 // app/products/page.tsx  9 async   function   ProductsPage \\( \\)   { 10     // Runs on server \\227 no useEffect, no loading state 11     const   products   =   await   db . product . findMany \\( {   where :   {   active :   true   }   } \\) 12     return   < ProductList   products = { products }   / > 13 } 14 15 // SSG: Next.js static generation \\(generated at build\\) 16 // app/blog/[slug]/page.tsx 17 export   async   function   generateStaticParams \\( \\)   { 18     const   posts   =   await   api . getAllPosts \\( \\) 19     return   posts . map \\( post   = >   \\( {   slug :   post . slug   } \\) \\) 20 } Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 22/42.",
    hints: [
      "Consider the core principles and trade-offs of What is the difference between CSR, SSR, SSG, and ISR? n   Answer Rendering strategy determines when and where HTML is generated. Each has different performance, SEO, and infrastructure implications. CSR \\227 Client-Side Rendering: Server sends empty HTML + JS bundle Browser downloads JS, executes, renders UI Good for: dashboards, admin panels, apps behind auth Bad for: SEO \\(empty HTML\\), slow FCP SSR \\227 Server-Side Rendering: Server renders full HTML on each request User sees content immediately \\(fast FCP\\) Good for: dynamic pages with user-specific data, SEO Bad for: server load, TTFB can be high SSG \\227 Static Site Generation: HTML generated at build time Served from CDN \\227 fastest possible Good for: blogs, marketing pages, documentation Bad for: dynamic user-specific content ISR \\227 Incremental Static Regeneration \\(Next.js\\): SSG pages regenerated in background after stale Best of SSG \\(speed\\) + SSR \\(freshness\\) Good for: product pages, news articles  1 // CSR: useEffect fetches after browser render  2 const   Dashboard   =   \\( \\)   = >   {  3     const   {   data   }   =   useQuery \\( {   queryKey :   [ 'dashboard' ] ,   queryFn :   api . getDashboard   } \\)  4     return   < DashboardView   data = { data }   / >  5 }  6  7 // SSR: Next.js App Router \\227 Server Component  8 // app/products/page.tsx  9 async   function   ProductsPage \\( \\)   { 10     // Runs on server \\227 no useEffect, no loading state 11     const   products   =   await   db . product . findMany \\( {   where :   {   active :   true   }   } \\) 12     return   < ProductList   products = { products }   / > 13 } 14 15 // SSG: Next.js static generation \\(generated at build\\) 16 // app/blog/[slug]/page.tsx 17 export   async   function   generateStaticParams \\( \\)   { 18     const   posts   =   await   api . getAllPosts \\( \\) 19     return   posts . map \\( post   = >   \\( {   slug :   post . slug   } \\) \\) 20 } Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 22/42."
    ],
    source: "frontend-system-design-50",
    estimatedMinutes: 4
  },
  {
    ...
    correctAnswer: "A",
    explanation: "25 < table > 26 < thead > 27 { table . getHeaderGroups ( ) . map ( hg = > ( 28 < tr key = { hg . id } > 29 { hg . headers . map ( header = > ( 30 < th key = { header . id } 31 onClick = { header . column . getToggleSortingHandler ( ) } 32 style = { { cursor : header . column . getCanSort ( ) ? 'pointer' : 'default' } } > 33 { flexRender ( header . column . columnDef . header , header . getContext ( ) ) } 34 { { asc : ' \\255 ' , desc : ' \\257 ' } [ header . column . getIsSorted ( ) ] ? ? '' } 35 < / th > 36 ) ) } 37 < / tr > 38 ) ) } 39 < / thead > 40 < tbody > 41 { table . getRowModel ( ) . rows . map ( row = > ( 42 < tr key = { row . id } > 43 { row . getVisibleCells ( ) . map ( cell = > ( 44 < td key = { cell . id } > 45 { flexRender ( cell . column . columnDef . cell , cell . getContext ( ) ) } 46 < / td > 47 ) ) } 48 < / tr > 49 ) ) } 50 < / tbody > 51 < / table > 52 < Pagination table = { table } / > 53 < / div > 54 ) 55 } n Interview Tip: Encode table state (sort, filters, page) in URL parameters. This makes the table state shareable \\227 users can copy a URL and send their exact filtered view to a colleague. It also restores state on page refresh. Use useSearchParams() to sync table state with the URL. Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn Frontend System Design | Comment 'FSD' for full PDF | Save \\267 Share \\267 Repost 25/42 nn FE Design",
    interviewLine: "Interview takeaway: Clearly articulate the underlying mechanism, lifecycle role, and performance trade-offs of How do you design a data table with sorting, filtering, and pagination? n   Answer A production data table handles thousands of rows, complex filters, and must remain performant. TanStack Table \\(react-table\\) is the standard: Headless \\227 you own the HTML/CSS, library owns the logic Server-side: sorting/filtering/pagination sent to API Client-side: all data in memory, sort/filter/page locally Server-side vs client-side: Client-side: < 500 rows, simple filtering Server-side: > 500 rows, complex filtering, API-driven Key features to implement: Column sort \\(asc/desc toggle, multi-sort\\) Filter per column \\(text, select, date range, number range\\) Pagination with page size selector Column resize and reorder Row selection with bulk actions Exportable \\(CSV, Excel\\) URL state for table config: Encode sort, filters, page in URL params Shareable, bookmarkable table state  1 import   {   useReactTable ,   getCoreRowModel ,   getSortedRowModel ,  2                   getFilteredRowModel ,   getPaginationRowModel   }   from   '@tanstack/react-table'  3  4 const   DataTable   =   \\( {   columns ,   data   } \\)   = >   {  5     const   [ sorting ,   setSorting ]       =   useState \\( [ ] \\)  6     const   [ filtering ,   setFiltering ]   =   useState \\( [ ] \\)  7     const   [ pagination ,   setPagination ]   =   useState \\( {   pageIndex :   0 ,   pageSize :   20   } \\)  8  9     const   table   =   useReactTable \\( { 10         data , 11         columns , 12         state :   {   sorting ,   columnFilters :   filtering ,   pagination   } , 13         onSortingChange :   setSorting , 14         onColumnFiltersChange :   setFiltering , 15         onPaginationChange :   setPagination , 16         getCoreRowModel :   getCoreRowModel \\( \\) , 17         getSortedRowModel :   getSortedRowModel \\( \\) , 18         getFilteredRowModel :   getFilteredRowModel \\( \\) , 19         getPaginationRowModel :   getPaginationRowModel \\( \\) , 20         manualPagination :   false ,     // true = server-side 21     } \\) 22 23     return   \\( 24         < div > Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 25/42.",
    misconception: "Common misconception: misunderstanding the execution lifecycle, reactivity triggers, or edge cases of How do you design a data table with sorting, filtering, and pagination? n   Answer A production data table handles thousands of rows, complex filters, and must remain performant. TanStack Table \\(react-table\\) is the standard: Headless \\227 you own the HTML/CSS, library owns the logic Server-side: sorting/filtering/pagination sent to API Client-side: all data in memory, sort/filter/page locally Server-side vs client-side: Client-side: < 500 rows, simple filtering Server-side: > 500 rows, complex filtering, API-driven Key features to implement: Column sort \\(asc/desc toggle, multi-sort\\) Filter per column \\(text, select, date range, number range\\) Pagination with page size selector Column resize and reorder Row selection with bulk actions Exportable \\(CSV, Excel\\) URL state for table config: Encode sort, filters, page in URL params Shareable, bookmarkable table state  1 import   {   useReactTable ,   getCoreRowModel ,   getSortedRowModel ,  2                   getFilteredRowModel ,   getPaginationRowModel   }   from   '@tanstack/react-table'  3  4 const   DataTable   =   \\( {   columns ,   data   } \\)   = >   {  5     const   [ sorting ,   setSorting ]       =   useState \\( [ ] \\)  6     const   [ filtering ,   setFiltering ]   =   useState \\( [ ] \\)  7     const   [ pagination ,   setPagination ]   =   useState \\( {   pageIndex :   0 ,   pageSize :   20   } \\)  8  9     const   table   =   useReactTable \\( { 10         data , 11         columns , 12         state :   {   sorting ,   columnFilters :   filtering ,   pagination   } , 13         onSortingChange :   setSorting , 14         onColumnFiltersChange :   setFiltering , 15         onPaginationChange :   setPagination , 16         getCoreRowModel :   getCoreRowModel \\( \\) , 17         getSortedRowModel :   getSortedRowModel \\( \\) , 18         getFilteredRowModel :   getFilteredRowModel \\( \\) , 19         getPaginationRowModel :   getPaginationRowModel \\( \\) , 20         manualPagination :   false ,     // true = server-side 21     } \\) 22 23     return   \\( 24         < div > Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 25/42.",
    hints: [
      "Consider the core principles and trade-offs of How do you design a data table with sorting, filtering, and pagination? n   Answer A production data table handles thousands of rows, complex filters, and must remain performant. TanStack Table \\(react-table\\) is the standard: Headless \\227 you own the HTML/CSS, library owns the logic Server-side: sorting/filtering/pagination sent to API Client-side: all data in memory, sort/filter/page locally Server-side vs client-side: Client-side: < 500 rows, simple filtering Server-side: > 500 rows, complex filtering, API-driven Key features to implement: Column sort \\(asc/desc toggle, multi-sort\\) Filter per column \\(text, select, date range, number range\\) Pagination with page size selector Column resize and reorder Row selection with bulk actions Exportable \\(CSV, Excel\\) URL state for table config: Encode sort, filters, page in URL params Shareable, bookmarkable table state  1 import   {   useReactTable ,   getCoreRowModel ,   getSortedRowModel ,  2                   getFilteredRowModel ,   getPaginationRowModel   }   from   '@tanstack/react-table'  3  4 const   DataTable   =   \\( {   columns ,   data   } \\)   = >   {  5     const   [ sorting ,   setSorting ]       =   useState \\( [ ] \\)  6     const   [ filtering ,   setFiltering ]   =   useState \\( [ ] \\)  7     const   [ pagination ,   setPagination ]   =   useState \\( {   pageIndex :   0 ,   pageSize :   20   } \\)  8  9     const   table   =   useReactTable \\( { 10         data , 11         columns , 12         state :   {   sorting ,   columnFilters :   filtering ,   pagination   } , 13         onSortingChange :   setSorting , 14         onColumnFiltersChange :   setFiltering , 15         onPaginationChange :   setPagination , 16         getCoreRowModel :   getCoreRowModel \\( \\) , 17         getSortedRowModel :   getSortedRowModel \\( \\) , 18         getFilteredRowModel :   getFilteredRowModel \\( \\) , 19         getPaginationRowModel :   getPaginationRowModel \\( \\) , 20         manualPagination :   false ,     // true = server-side 21     } \\) 22 23     return   \\( 24         < div > Kaushal Singh Follow for Frontend \\267 System Design \\267 Interview Prep nn  Frontend System Design  |  Comment 'FSD' for full PDF  |  Save \\267 Share \\267 Repost 25/42."
